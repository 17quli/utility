// ORM class for table 'lannz_keyofficeholderpositions'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:39:07 NZDT 2020
...
public class lannz_keyofficeholderpositions extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_keyofficeholderpositions.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrPosition", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_keyofficeholderpositions.this.fstrPosition = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_keyofficeholderpositions.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_keyofficeholderpositions.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_keyofficeholderpositions.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_keyofficeholderpositions() {
    init0();
  }
  ...
  public lannz_keyofficeholderpositions with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrPosition;
  public String get_fstrPosition() {
    return fstrPosition;
  }
  public void set_fstrPosition(String fstrPosition) {
    this.fstrPosition = fstrPosition;
  }
  public lannz_keyofficeholderpositions with_fstrPosition(String fstrPosition) {
    this.fstrPosition = fstrPosition;
    return this;
  }
  ...
  public lannz_keyofficeholderpositions with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_keyofficeholderpositions with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_keyofficeholderpositions with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_keyofficeholderpositions)) {
      return false;
    }
    lannz_keyofficeholderpositions that = (lannz_keyofficeholderpositions) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrPosition == null ? that.fstrPosition == null : this.fstrPosition.equals(that.fstrPosition));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrPosition = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrPosition, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrPosition = null;
    } else {
    this.fstrPosition = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrPosition) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrPosition);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrPosition==null?"\\N":fstrPosition, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrPosition = null; } else {
      this.fstrPosition = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_keyofficeholderpositions o = (lannz_keyofficeholderpositions) super.clone();
    return o;
  }

  public void clone0(lannz_keyofficeholderpositions o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrPosition", this.fstrPosition);
