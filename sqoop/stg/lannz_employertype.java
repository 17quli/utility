// ORM class for table 'lannz_employertype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 22:47:12 NZDT 2020
...
public class lannz_employertype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_employertype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrEmployerType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_employertype.this.fstrEmployerType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_employertype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_employertype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrWebDecode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_employertype.this.fstrWebDecode = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_employertype.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_employertype() {
    init0();
  }
  ...
  public lannz_employertype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrEmployerType;
  public String get_fstrEmployerType() {
    return fstrEmployerType;
  }
  public void set_fstrEmployerType(String fstrEmployerType) {
    this.fstrEmployerType = fstrEmployerType;
  }
  public lannz_employertype with_fstrEmployerType(String fstrEmployerType) {
    this.fstrEmployerType = fstrEmployerType;
    return this;
  }
  ...
  public lannz_employertype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_employertype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_employertype with_fstrWebDecode(String fstrWebDecode) {
    this.fstrWebDecode = fstrWebDecode;
    return this;
  }
  ...
  public lannz_employertype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_employertype)) {
      return false;
    }
    lannz_employertype that = (lannz_employertype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrEmployerType == null ? that.fstrEmployerType == null : this.fstrEmployerType.equals(that.fstrEmployerType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrEmployerType = JdbcWritableBridge.readString(2, __dbResults);
    this.fstrDecode1 = JdbcWritableBridge.readString(3, __dbResults);
    this.fstrDecode2 = JdbcWritableBridge.readString(4, __dbResults);
    this.fstrWebDecode = JdbcWritableBridge.readString(5, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrEmployerType, 2 + __off, -9, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrWebDecode, 5 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrEmployerType = null;
    } else {
    this.fstrEmployerType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrEmployerType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrEmployerType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrEmployerType==null?"\\N":fstrEmployerType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrEmployerType = null; } else {
      this.fstrEmployerType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_employertype o = (lannz_employertype) super.clone();
    return o;
  }

  public void clone0(lannz_employertype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrEmployerType", this.fstrEmployerType);
