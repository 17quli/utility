// ORM class for table 'lanwebnoticesubtype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:50:32 NZDT 2020
...
public class lanwebnoticesubtype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrWebNoticeSubType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrWebNoticeSubType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrDescription = (String)value;
      }
    });
    setters.put("fstrDecodeWeb1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrDecodeWeb1 = (String)value;
      }
    });
    setters.put("fstrDecodeWeb2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrDecodeWeb2 = (String)value;
      }
    });
    setters.put("fstrDescriptionWeb", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticesubtype.this.fstrDescriptionWeb = (String)value;
      }
    });
  }
  public lanwebnoticesubtype() {
    init0();
  }
  ...
  public lanwebnoticesubtype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrWebNoticeSubType;
  public String get_fstrWebNoticeSubType() {
    return fstrWebNoticeSubType;
  }
  public void set_fstrWebNoticeSubType(String fstrWebNoticeSubType) {
    this.fstrWebNoticeSubType = fstrWebNoticeSubType;
  }
  public lanwebnoticesubtype with_fstrWebNoticeSubType(String fstrWebNoticeSubType) {
    this.fstrWebNoticeSubType = fstrWebNoticeSubType;
    return this;
  }
  ...
  public lanwebnoticesubtype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanwebnoticesubtype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanwebnoticesubtype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  ...
  public lanwebnoticesubtype with_fstrDecodeWeb1(String fstrDecodeWeb1) {
    this.fstrDecodeWeb1 = fstrDecodeWeb1;
    return this;
  }
  ...
  public lanwebnoticesubtype with_fstrDecodeWeb2(String fstrDecodeWeb2) {
    this.fstrDecodeWeb2 = fstrDecodeWeb2;
    return this;
  }
  ...
  public lanwebnoticesubtype with_fstrDescriptionWeb(String fstrDescriptionWeb) {
    this.fstrDescriptionWeb = fstrDescriptionWeb;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanwebnoticesubtype)) {
      return false;
    }
    lanwebnoticesubtype that = (lanwebnoticesubtype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrWebNoticeSubType == null ? that.fstrWebNoticeSubType == null : this.fstrWebNoticeSubType.equals(that.fstrWebNoticeSubType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrWebNoticeSubType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrWebNoticeSubType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrWebNoticeSubType = null;
    } else {
    this.fstrWebNoticeSubType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrWebNoticeSubType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrWebNoticeSubType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrWebNoticeSubType==null?"\\N":fstrWebNoticeSubType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrWebNoticeSubType = null; } else {
      this.fstrWebNoticeSubType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanwebnoticesubtype o = (lanwebnoticesubtype) super.clone();
    return o;
  }

  public void clone0(lanwebnoticesubtype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrWebNoticeSubType", this.fstrWebNoticeSubType);
