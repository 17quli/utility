// ORM class for table 'lantitleuser'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:20:44 NZDT 2020
...
public class lantitleuser extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("FSTRLANGUAGE", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lantitleuser.this.FSTRLANGUAGE = (String)value;
      }
    });
    setters.put("FSTRTITLEUSER", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lantitleuser.this.FSTRTITLEUSER = (String)value;
      }
    });
    setters.put("FSTRDECODE1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lantitleuser.this.FSTRDECODE1 = (String)value;
      }
    });
    setters.put("FSTRDECODE2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lantitleuser.this.FSTRDECODE2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lantitleuser.this.fstrDescription = (String)value;
      }
    });
  }
  public lantitleuser() {
  ...
  public lantitleuser with_FSTRLANGUAGE(String FSTRLANGUAGE) {
    this.FSTRLANGUAGE = FSTRLANGUAGE;
    return this;
  }
  private String FSTRTITLEUSER;
  public String get_FSTRTITLEUSER() {
    return FSTRTITLEUSER;
  }
  public void set_FSTRTITLEUSER(String FSTRTITLEUSER) {
    this.FSTRTITLEUSER = FSTRTITLEUSER;
  }
  public lantitleuser with_FSTRTITLEUSER(String FSTRTITLEUSER) {
    this.FSTRTITLEUSER = FSTRTITLEUSER;
    return this;
  }
  ...
  public lantitleuser with_FSTRDECODE1(String FSTRDECODE1) {
    this.FSTRDECODE1 = FSTRDECODE1;
    return this;
  }
  ...
  public lantitleuser with_FSTRDECODE2(String FSTRDECODE2) {
    this.FSTRDECODE2 = FSTRDECODE2;
    return this;
  }
  ...
  public lantitleuser with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lantitleuser)) {
      return false;
    }
    lantitleuser that = (lantitleuser) o;
    boolean equal = true;
    equal = equal && (this.FSTRLANGUAGE == null ? that.FSTRLANGUAGE == null : this.FSTRLANGUAGE.equals(that.FSTRLANGUAGE));
    equal = equal && (this.FSTRTITLEUSER == null ? that.FSTRTITLEUSER == null : this.FSTRTITLEUSER.equals(that.FSTRTITLEUSER));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.FSTRTITLEUSER = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(FSTRTITLEUSER, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.FSTRTITLEUSER = null;
    } else {
    this.FSTRTITLEUSER = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.FSTRTITLEUSER) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, FSTRTITLEUSER);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(FSTRTITLEUSER==null?"\\N":FSTRTITLEUSER, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.FSTRTITLEUSER = null; } else {
      this.FSTRTITLEUSER = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lantitleuser o = (lantitleuser) super.clone();
    return o;
  }

  public void clone0(lantitleuser o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("FSTRLANGUAGE", this.FSTRLANGUAGE);
    __sqoop$field_map.put("FSTRTITLEUSER", this.FSTRTITLEUSER);
