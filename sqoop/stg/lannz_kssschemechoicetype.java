// ORM class for table 'lannz_kssschemechoicetype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:18:51 NZDT 2020
...
public class lannz_kssschemechoicetype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_kssschemechoicetype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrSchemeChoice", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssschemechoicetype.this.fstrSchemeChoice = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssschemechoicetype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssschemechoicetype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssschemechoicetype.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_kssschemechoicetype() {
    init0();
  }
  ...
  public lannz_kssschemechoicetype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrSchemeChoice;
  public String get_fstrSchemeChoice() {
    return fstrSchemeChoice;
  }
  public void set_fstrSchemeChoice(String fstrSchemeChoice) {
    this.fstrSchemeChoice = fstrSchemeChoice;
  }
  public lannz_kssschemechoicetype with_fstrSchemeChoice(String fstrSchemeChoice) {
    this.fstrSchemeChoice = fstrSchemeChoice;
    return this;
  }
  ...
  public lannz_kssschemechoicetype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_kssschemechoicetype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_kssschemechoicetype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_kssschemechoicetype)) {
      return false;
    }
    lannz_kssschemechoicetype that = (lannz_kssschemechoicetype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrSchemeChoice == null ? that.fstrSchemeChoice == null : this.fstrSchemeChoice.equals(that.fstrSchemeChoice));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrSchemeChoice = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrSchemeChoice, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrSchemeChoice = null;
    } else {
    this.fstrSchemeChoice = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrSchemeChoice) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrSchemeChoice);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrSchemeChoice==null?"\\N":fstrSchemeChoice, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrSchemeChoice = null; } else {
      this.fstrSchemeChoice = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_kssschemechoicetype o = (lannz_kssschemechoicetype) super.clone();
    return o;
  }

  public void clone0(lannz_kssschemechoicetype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrSchemeChoice", this.fstrSchemeChoice);
