// ORM class for table 'tblnz_statementofactivity'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 01:14:19 NZDT 2020
...
public class tblnz_statementofactivity extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  public static interface FieldSetterCommand {    void setField(Object value);  }  protected ResultSet __cur_result_set;
  private Map<String, FieldSetterCommand> setters = new HashMap<String, FieldSetterCommand>();
  private void init0() {
    setters.put("flngSOAKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.flngSOAKey = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("fdtmFilingPeriod", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fdtmFilingPeriod = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrFilingFrequency", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fstrFilingFrequency = (String)value;
      }
    });
    setters.put("flngDocKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("fdtmSentToFIRST", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fdtmSentToFIRST = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmReceived", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fdtmReceived = (java.sql.Timestamp)value;
      }
    });
    setters.put("fblnActive", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fblnActive = (Integer)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_statementofactivity.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_statementofactivity() {
    init0();
  }
  private Integer flngSOAKey;
  public Integer get_flngSOAKey() {
    return flngSOAKey;
  }
  public void set_flngSOAKey(Integer flngSOAKey) {
    this.flngSOAKey = flngSOAKey;
  }
  public tblnz_statementofactivity with_flngSOAKey(Integer flngSOAKey) {
    this.flngSOAKey = flngSOAKey;
    return this;
  }
  ...
  public tblnz_statementofactivity with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblnz_statementofactivity with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblnz_statementofactivity with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fdtmFilingPeriod(java.sql.Timestamp fdtmFilingPeriod) {
    this.fdtmFilingPeriod = fdtmFilingPeriod;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fstrFilingFrequency(String fstrFilingFrequency) {
    this.fstrFilingFrequency = fstrFilingFrequency;
    return this;
  }
  ...
  public tblnz_statementofactivity with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fdtmSentToFIRST(java.sql.Timestamp fdtmSentToFIRST) {
    this.fdtmSentToFIRST = fdtmSentToFIRST;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fdtmReceived(java.sql.Timestamp fdtmReceived) {
    this.fdtmReceived = fdtmReceived;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fblnActive(Integer fblnActive) {
    this.fblnActive = fblnActive;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_statementofactivity with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_statementofactivity)) {
      return false;
    }
    tblnz_statementofactivity that = (tblnz_statementofactivity) o;
    boolean equal = true;
    equal = equal && (this.flngSOAKey == null ? that.flngSOAKey == null : this.flngSOAKey.equals(that.flngSOAKey));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngSOAKey = JdbcWritableBridge.readInteger(1, __dbResults);
    ...
    this.fdtmReceived = JdbcWritableBridge.readTimestamp(9, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(flngSOAKey, 1 + __off, 4, __dbStmt);
    ...
    JdbcWritableBridge.writeTimestamp(fdtmReceived, 9 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    if (__dataIn.readBoolean()) { 
        this.flngSOAKey = null;
    } else {
    this.flngSOAKey = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.flngVer = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    if (null == this.flngSOAKey) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.flngSOAKey);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(flngSOAKey==null?"\\N":"" + flngSOAKey, delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.flngSOAKey = null; } else {
      this.flngSOAKey = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_statementofactivity o = (tblnz_statementofactivity) super.clone();
  ...
  public void clone0(tblnz_statementofactivity o) throws CloneNotSupportedException {
    o.fdtmFilingPeriod = (o.fdtmFilingPeriod != null) ? (java.sql.Timestamp) o.fdtmFilingPeriod.clone() : null;
    o.fdtmSentToFIRST = (o.fdtmSentToFIRST != null) ? (java.sql.Timestamp) o.fdtmSentToFIRST.clone() : null;
    o.fdtmReceived = (o.fdtmReceived != null) ? (java.sql.Timestamp) o.fdtmReceived.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("flngSOAKey", this.flngSOAKey);
