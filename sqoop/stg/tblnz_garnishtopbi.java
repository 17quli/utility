// ORM class for table 'tblnz_garnishtopbi'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 02:54:44 NZDT 2020
...
public class tblnz_garnishtopbi extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngGarnishKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_garnishtopbi.this.flngGarnishKey = (Integer)value;
      }
    });
    setters.put("flngBillItemKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.flngBillItemKey = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("flngCustomRateKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.flngCustomRateKey = (Integer)value;
      }
    });
    setters.put("fdtmStartEval", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.fdtmStartEval = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_garnishtopbi.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_garnishtopbi() {
    init0();
  }
  ...
  public tblnz_garnishtopbi with_flngGarnishKey(Integer flngGarnishKey) {
    this.flngGarnishKey = flngGarnishKey;
    return this;
  }
  ...
  public tblnz_garnishtopbi with_flngBillItemKey(Integer flngBillItemKey) {
    this.flngBillItemKey = flngBillItemKey;
    return this;
  }
  ...
  public tblnz_garnishtopbi with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblnz_garnishtopbi with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblnz_garnishtopbi with_flngCustomRateKey(Integer flngCustomRateKey) {
    this.flngCustomRateKey = flngCustomRateKey;
    return this;
  }
  private java.sql.Timestamp fdtmStartEval;
  public java.sql.Timestamp get_fdtmStartEval() {
    return fdtmStartEval;
  }
  public void set_fdtmStartEval(java.sql.Timestamp fdtmStartEval) {
    this.fdtmStartEval = fdtmStartEval;
  }
  public tblnz_garnishtopbi with_fdtmStartEval(java.sql.Timestamp fdtmStartEval) {
    this.fdtmStartEval = fdtmStartEval;
    return this;
  }
  ...
  public tblnz_garnishtopbi with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_garnishtopbi with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_garnishtopbi)) {
      return false;
    }
    tblnz_garnishtopbi that = (tblnz_garnishtopbi) o;
    boolean equal = true;
    ...
    equal = equal && (this.fdtmStartEval == null ? that.fdtmStartEval == null : this.fdtmStartEval.equals(that.fdtmStartEval));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngCustomRateKey = JdbcWritableBridge.readInteger(5, __dbResults);
    this.fdtmStartEval = JdbcWritableBridge.readTimestamp(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(flngCustomRateKey, 5 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmStartEval, 6 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fdtmStartEval = null;
    } else {
    this.fdtmStartEval = new Timestamp(__dataIn.readLong());
    this.fdtmStartEval.setNanos(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.fstrWho = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fdtmStartEval) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeLong(this.fdtmStartEval.getTime());
    __dataOut.writeInt(this.fdtmStartEval.getNanos());
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fdtmStartEval==null?"\\N":"" + fdtmStartEval, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fdtmStartEval = null; } else {
      this.fdtmStartEval = java.sql.Timestamp.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_garnishtopbi o = (tblnz_garnishtopbi) super.clone();
    o.fdtmStartEval = (o.fdtmStartEval != null) ? (java.sql.Timestamp) o.fdtmStartEval.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
    return o;
  }

  public void clone0(tblnz_garnishtopbi o) throws CloneNotSupportedException {
    o.fdtmStartEval = (o.fdtmStartEval != null) ? (java.sql.Timestamp) o.fdtmStartEval.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fdtmStartEval", this.fdtmStartEval);
