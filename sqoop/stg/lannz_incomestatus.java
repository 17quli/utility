// ORM class for table 'lannz_incomestatus'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:25:48 NZDT 2020
...
public class lannz_incomestatus extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_incomestatus.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrIncomeStatus", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_incomestatus.this.fstrIncomeStatus = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_incomestatus.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_incomestatus.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_incomestatus.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_incomestatus() {
    init0();
  }
  ...
  public lannz_incomestatus with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrIncomeStatus;
  public String get_fstrIncomeStatus() {
    return fstrIncomeStatus;
  }
  public void set_fstrIncomeStatus(String fstrIncomeStatus) {
    this.fstrIncomeStatus = fstrIncomeStatus;
  }
  public lannz_incomestatus with_fstrIncomeStatus(String fstrIncomeStatus) {
    this.fstrIncomeStatus = fstrIncomeStatus;
    return this;
  }
  ...
  public lannz_incomestatus with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_incomestatus with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_incomestatus with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_incomestatus)) {
      return false;
    }
    lannz_incomestatus that = (lannz_incomestatus) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrIncomeStatus == null ? that.fstrIncomeStatus == null : this.fstrIncomeStatus.equals(that.fstrIncomeStatus));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrIncomeStatus = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrIncomeStatus, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrIncomeStatus = null;
    } else {
    this.fstrIncomeStatus = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrIncomeStatus) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrIncomeStatus);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrIncomeStatus==null?"\\N":fstrIncomeStatus, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrIncomeStatus = null; } else {
      this.fstrIncomeStatus = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_incomestatus o = (lannz_incomestatus) super.clone();
    return o;
  }

  public void clone0(lannz_incomestatus o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrIncomeStatus", this.fstrIncomeStatus);
