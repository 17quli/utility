// ORM class for table 'lannz_amendreason'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:32:49 NZDT 2020
...
public class lannz_amendreason extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_amendreason.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrAmendReason", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_amendreason.this.fstrAmendReason = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_amendreason.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_amendreason.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDecodeWeb", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_amendreason.this.fstrDecodeWeb = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_amendreason.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_amendreason() {
    init0();
  }
  ...
  public lannz_amendreason with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lannz_amendreason with_fstrAmendReason(String fstrAmendReason) {
    this.fstrAmendReason = fstrAmendReason;
    return this;
  }
  ...
  public lannz_amendreason with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_amendreason with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_amendreason with_fstrDecodeWeb(String fstrDecodeWeb) {
    this.fstrDecodeWeb = fstrDecodeWeb;
    return this;
  }
  ...
  public lannz_amendreason with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_amendreason)) {
      return false;
    }
    lannz_amendreason that = (lannz_amendreason) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrAmendReason = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrAmendReason, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrAmendReason==null?"\\N":fstrAmendReason, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_amendreason o = (lannz_amendreason) super.clone();
    return o;
  }

  public void clone0(lannz_amendreason o) throws CloneNotSupportedException {
  }
