// ORM class for table 'lannz_customersegments'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:02:25 NZDT 2020
...
public class lannz_customersegments extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  public static interface FieldSetterCommand {    void setField(Object value);  }  protected ResultSet __cur_result_set;
  private Map<String, FieldSetterCommand> setters = new HashMap<String, FieldSetterCommand>();
  private void init0() {
    setters.put("fstrSegment", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_customersegments.this.fstrSegment = (String)value;
      }
    });
    setters.put("fstrLanguage", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_customersegments.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_customersegments.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_customersegments.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_customersegments.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_customersegments() {
    init0();
  }
  private String fstrSegment;
  public String get_fstrSegment() {
    return fstrSegment;
  }
  public void set_fstrSegment(String fstrSegment) {
    this.fstrSegment = fstrSegment;
  }
  public lannz_customersegments with_fstrSegment(String fstrSegment) {
    this.fstrSegment = fstrSegment;
    return this;
  }
  ...
  public lannz_customersegments with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lannz_customersegments with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_customersegments with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_customersegments with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_customersegments)) {
      return false;
    }
    lannz_customersegments that = (lannz_customersegments) o;
    boolean equal = true;
    equal = equal && (this.fstrSegment == null ? that.fstrSegment == null : this.fstrSegment.equals(that.fstrSegment));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrSegment = JdbcWritableBridge.readString(1, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(fstrSegment, 1 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    if (__dataIn.readBoolean()) { 
        this.fstrSegment = null;
    } else {
    this.fstrSegment = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    if (null == this.fstrSegment) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrSegment);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrSegment==null?"\\N":fstrSegment, " ", delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrSegment = null; } else {
      this.fstrSegment = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_customersegments o = (lannz_customersegments) super.clone();
    return o;
  }

  public void clone0(lannz_customersegments o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrSegment", this.fstrSegment);
