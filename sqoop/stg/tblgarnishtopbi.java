// ORM class for table 'tblgarnishtopbi'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 06:14:39 NZDT 2020
...
public class tblgarnishtopbi extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngGarnishKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblgarnishtopbi.this.flngGarnishKey = (Integer)value;
      }
    });
    setters.put("flngBillItemKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.flngBillItemKey = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("fintBillItem", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.fintBillItem = (Integer)value;
      }
    });
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("flngAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fdtmFilingPeriod", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.fdtmFilingPeriod = (java.sql.Timestamp)value;
      }
    });
    setters.put("flngJointIndicatorKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.flngJointIndicatorKey = (Integer)value;
      }
    });
    setters.put("fblnActive", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.fblnActive = (Integer)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblgarnishtopbi.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblgarnishtopbi() {
    init0();
  }
  ...
  public tblgarnishtopbi with_flngGarnishKey(Integer flngGarnishKey) {
    this.flngGarnishKey = flngGarnishKey;
    return this;
  }
  ...
  public tblgarnishtopbi with_flngBillItemKey(Integer flngBillItemKey) {
    this.flngBillItemKey = flngBillItemKey;
    return this;
  }
  ...
  public tblgarnishtopbi with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblgarnishtopbi with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblgarnishtopbi with_fintBillItem(Integer fintBillItem) {
    this.fintBillItem = fintBillItem;
    return this;
  }
  ...
  public tblgarnishtopbi with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblgarnishtopbi with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  ...
  public tblgarnishtopbi with_fdtmFilingPeriod(java.sql.Timestamp fdtmFilingPeriod) {
    this.fdtmFilingPeriod = fdtmFilingPeriod;
    return this;
  }
  ...
  public tblgarnishtopbi with_flngJointIndicatorKey(Integer flngJointIndicatorKey) {
    this.flngJointIndicatorKey = flngJointIndicatorKey;
    return this;
  }
  ...
  public tblgarnishtopbi with_fblnActive(Integer fblnActive) {
    this.fblnActive = fblnActive;
    return this;
  }
  ...
  public tblgarnishtopbi with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblgarnishtopbi with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblgarnishtopbi)) {
      return false;
    }
    tblgarnishtopbi that = (tblgarnishtopbi) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngBillItemKey = JdbcWritableBridge.readInteger(2, __dbResults);
    this.flngVer = JdbcWritableBridge.readInteger(3, __dbResults);
    this.flngVerLast = JdbcWritableBridge.readInteger(4, __dbResults);
    this.fintBillItem = JdbcWritableBridge.readInteger(5, __dbResults);
    ...
    this.flngJointIndicatorKey = JdbcWritableBridge.readInteger(9, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(flngBillItemKey, 2 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngVer, 3 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngVerLast, 4 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(fintBillItem, 5 + __off, 5, __dbStmt);
    ...
    JdbcWritableBridge.writeInteger(flngJointIndicatorKey, 9 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblgarnishtopbi o = (tblgarnishtopbi) super.clone();
    o.fdtmFilingPeriod = (o.fdtmFilingPeriod != null) ? (java.sql.Timestamp) o.fdtmFilingPeriod.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
    return o;
  }

  public void clone0(tblgarnishtopbi o) throws CloneNotSupportedException {
    o.fdtmFilingPeriod = (o.fdtmFilingPeriod != null) ? (java.sql.Timestamp) o.fdtmFilingPeriod.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
