// ORM class for table 'tblnz_customsals'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 05:06:40 NZDT 2020
...
public class tblnz_customsals extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fi64GatewayWebServiceOutKeyAdd", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_customsals.this.fi64GatewayWebServiceOutKeyAdd = (Long)value;
      }
    });
    setters.put("fi64GatewayWebServiceOutKeyDel", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fi64GatewayWebServiceOutKeyDel = (Long)value;
      }
    });
    setters.put("fi64BatchKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fi64BatchKey = (Long)value;
      }
    });
    setters.put("fintSeq", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fintSeq = (Integer)value;
      }
    });
    setters.put("flngAlertId", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.flngAlertId = (Integer)value;
      }
    });
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("flngAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fstrAccountType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrAccountType = (String)value;
      }
    });
    setters.put("fstrIRDNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrIRDNumber = (String)value;
      }
    });
    setters.put("fstrGivenName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrGivenName = (String)value;
      }
    });
    setters.put("fstrFamilyName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrFamilyName = (String)value;
      }
    });
    setters.put("fdtmDOB", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fdtmDOB = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrPassportNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrPassportNumber = (String)value;
      }
    });
    setters.put("fstrPassportCountryCode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrPassportCountryCode = (String)value;
      }
    });
    setters.put("fdtmAdded", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fdtmAdded = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmDeleted", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fdtmDeleted = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmLastProcessed", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fdtmLastProcessed = (java.sql.Timestamp)value;
      }
    });
    setters.put("fblnAdd", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fblnAdd = (Integer)value;
      }
    });
    setters.put("fblnDelete", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fblnDelete = (Integer)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_customsals.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_customsals() {
    init0();
  }
  ...
  public tblnz_customsals with_fi64GatewayWebServiceOutKeyAdd(Long fi64GatewayWebServiceOutKeyAdd) {
    this.fi64GatewayWebServiceOutKeyAdd = fi64GatewayWebServiceOutKeyAdd;
    return this;
  }
  ...
  public tblnz_customsals with_fi64GatewayWebServiceOutKeyDel(Long fi64GatewayWebServiceOutKeyDel) {
    this.fi64GatewayWebServiceOutKeyDel = fi64GatewayWebServiceOutKeyDel;
    return this;
  }
  ...
  public tblnz_customsals with_fi64BatchKey(Long fi64BatchKey) {
    this.fi64BatchKey = fi64BatchKey;
    return this;
  }
  ...
  public tblnz_customsals with_fintSeq(Integer fintSeq) {
    this.fintSeq = fintSeq;
    return this;
  }
  private Integer flngAlertId;
  public Integer get_flngAlertId() {
    return flngAlertId;
  }
  public void set_flngAlertId(Integer flngAlertId) {
    this.flngAlertId = flngAlertId;
  }
  public tblnz_customsals with_flngAlertId(Integer flngAlertId) {
    this.flngAlertId = flngAlertId;
    return this;
  }
  ...
  public tblnz_customsals with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblnz_customsals with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  ...
  public tblnz_customsals with_fstrAccountType(String fstrAccountType) {
    this.fstrAccountType = fstrAccountType;
    return this;
  }
  ...
  public tblnz_customsals with_fstrIRDNumber(String fstrIRDNumber) {
    this.fstrIRDNumber = fstrIRDNumber;
    return this;
  }
  ...
  public tblnz_customsals with_fstrGivenName(String fstrGivenName) {
    this.fstrGivenName = fstrGivenName;
    return this;
  }
  ...
  public tblnz_customsals with_fstrFamilyName(String fstrFamilyName) {
    this.fstrFamilyName = fstrFamilyName;
    return this;
  }
  ...
  public tblnz_customsals with_fdtmDOB(java.sql.Timestamp fdtmDOB) {
    this.fdtmDOB = fdtmDOB;
    return this;
  }
  ...
  public tblnz_customsals with_fstrPassportNumber(String fstrPassportNumber) {
    this.fstrPassportNumber = fstrPassportNumber;
    return this;
  }
  ...
  public tblnz_customsals with_fstrPassportCountryCode(String fstrPassportCountryCode) {
    this.fstrPassportCountryCode = fstrPassportCountryCode;
    return this;
  }
  ...
  public tblnz_customsals with_fdtmAdded(java.sql.Timestamp fdtmAdded) {
    this.fdtmAdded = fdtmAdded;
    return this;
  }
  ...
  public tblnz_customsals with_fdtmDeleted(java.sql.Timestamp fdtmDeleted) {
    this.fdtmDeleted = fdtmDeleted;
    return this;
  }
  ...
  public tblnz_customsals with_fdtmLastProcessed(java.sql.Timestamp fdtmLastProcessed) {
    this.fdtmLastProcessed = fdtmLastProcessed;
    return this;
  }
  ...
  public tblnz_customsals with_fblnAdd(Integer fblnAdd) {
    this.fblnAdd = fblnAdd;
    return this;
  }
  ...
  public tblnz_customsals with_fblnDelete(Integer fblnDelete) {
    this.fblnDelete = fblnDelete;
    return this;
  }
  ...
  public tblnz_customsals with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_customsals with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_customsals)) {
      return false;
    }
    tblnz_customsals that = (tblnz_customsals) o;
    boolean equal = true;
    ...
    equal = equal && (this.flngAlertId == null ? that.flngAlertId == null : this.flngAlertId.equals(that.flngAlertId));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngAlertId = JdbcWritableBridge.readInteger(5, __dbResults);
    ...
    this.fstrGivenName = JdbcWritableBridge.readString(10, __dbResults);
    this.fstrFamilyName = JdbcWritableBridge.readString(11, __dbResults);
    this.fdtmDOB = JdbcWritableBridge.readTimestamp(12, __dbResults);
    this.fstrPassportNumber = JdbcWritableBridge.readString(13, __dbResults);
    this.fstrPassportCountryCode = JdbcWritableBridge.readString(14, __dbResults);
    this.fdtmAdded = JdbcWritableBridge.readTimestamp(15, __dbResults);
    this.fdtmDeleted = JdbcWritableBridge.readTimestamp(16, __dbResults);
    this.fdtmLastProcessed = JdbcWritableBridge.readTimestamp(17, __dbResults);
    this.fblnAdd = JdbcWritableBridge.readInteger(18, __dbResults);
    this.fblnDelete = JdbcWritableBridge.readInteger(19, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(flngAlertId, 5 + __off, 4, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrGivenName, 10 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrFamilyName, 11 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmDOB, 12 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(fstrPassportNumber, 13 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrPassportCountryCode, 14 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmAdded, 15 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmDeleted, 16 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmLastProcessed, 17 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnAdd, 18 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnDelete, 19 + __off, -6, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.flngAlertId = null;
    } else {
    this.flngAlertId = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.flngAlertId) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.flngAlertId);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(flngAlertId==null?"\\N":"" + flngAlertId, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.flngAlertId = null; } else {
      this.flngAlertId = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_customsals o = (tblnz_customsals) super.clone();
  ...
  public void clone0(tblnz_customsals o) throws CloneNotSupportedException {
    o.fdtmDOB = (o.fdtmDOB != null) ? (java.sql.Timestamp) o.fdtmDOB.clone() : null;
    o.fdtmAdded = (o.fdtmAdded != null) ? (java.sql.Timestamp) o.fdtmAdded.clone() : null;
    o.fdtmDeleted = (o.fdtmDeleted != null) ? (java.sql.Timestamp) o.fdtmDeleted.clone() : null;
    o.fdtmLastProcessed = (o.fdtmLastProcessed != null) ? (java.sql.Timestamp) o.fdtmLastProcessed.clone() : null;
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("flngAlertId", this.flngAlertId);
