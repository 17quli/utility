// ORM class for table 'lanschtaskparm'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:00:42 NZDT 2020
...
public class lanschtaskparm extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanschtaskparm.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrSchName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanschtaskparm.this.fstrSchName = (String)value;
      }
    });
    setters.put("fstrParameter", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanschtaskparm.this.fstrParameter = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanschtaskparm.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanschtaskparm.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanschtaskparm.this.fstrDescription = (String)value;
      }
    });
  }
  public lanschtaskparm() {
    init0();
  }
  ...
  public lanschtaskparm with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrSchName;
  public String get_fstrSchName() {
    return fstrSchName;
  }
  public void set_fstrSchName(String fstrSchName) {
    this.fstrSchName = fstrSchName;
  }
  public lanschtaskparm with_fstrSchName(String fstrSchName) {
    this.fstrSchName = fstrSchName;
    return this;
  }
  private String fstrParameter;
  public String get_fstrParameter() {
    return fstrParameter;
  }
  public void set_fstrParameter(String fstrParameter) {
    this.fstrParameter = fstrParameter;
  }
  public lanschtaskparm with_fstrParameter(String fstrParameter) {
    this.fstrParameter = fstrParameter;
    return this;
  }
  ...
  public lanschtaskparm with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanschtaskparm with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanschtaskparm with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanschtaskparm)) {
      return false;
    }
    lanschtaskparm that = (lanschtaskparm) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrSchName == null ? that.fstrSchName == null : this.fstrSchName.equals(that.fstrSchName));
    equal = equal && (this.fstrParameter == null ? that.fstrParameter == null : this.fstrParameter.equals(that.fstrParameter));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrSchName = JdbcWritableBridge.readString(2, __dbResults);
    this.fstrParameter = JdbcWritableBridge.readString(3, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrSchName, 2 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrParameter, 3 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrSchName = null;
    } else {
    this.fstrSchName = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.fstrParameter = null;
    } else {
    this.fstrParameter = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrSchName) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrSchName);
    }
    if (null == this.fstrParameter) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrParameter);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrSchName==null?"\\N":fstrSchName, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrParameter==null?"\\N":fstrParameter, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrSchName = null; } else {
      this.fstrSchName = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.fstrParameter = null; } else {
      this.fstrParameter = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanschtaskparm o = (lanschtaskparm) super.clone();
    return o;
  }

  public void clone0(lanschtaskparm o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrSchName", this.fstrSchName);
    __sqoop$field_map.put("fstrParameter", this.fstrParameter);
