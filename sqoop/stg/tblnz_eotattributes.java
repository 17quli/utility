// ORM class for table 'tblnz_eotattributes'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 06:46:23 NZDT 2020
...
public class tblnz_eotattributes extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngDocKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_eotattributes.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("flngAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fstrAccountType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fstrAccountType = (String)value;
      }
    });
    setters.put("fdtmFilingPeriod", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fdtmFilingPeriod = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrEOTType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fstrEOTType = (String)value;
      }
    });
    setters.put("fstrStatus", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fstrStatus = (String)value;
      }
    });
    setters.put("fblnWithdrawnForLfp", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fblnWithdrawnForLfp = (Integer)value;
      }
    });
    setters.put("fblnManualOverride", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fblnManualOverride = (Integer)value;
      }
    });
    setters.put("fdtmDeferredDate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fdtmDeferredDate = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmExtensionDate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fdtmExtensionDate = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmTerminalTaxDue", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fdtmTerminalTaxDue = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmReplicated", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fdtmReplicated = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_eotattributes.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_eotattributes() {
    init0();
  }
  ...
  public tblnz_eotattributes with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblnz_eotattributes with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  ...
  public tblnz_eotattributes with_fstrAccountType(String fstrAccountType) {
    this.fstrAccountType = fstrAccountType;
    return this;
  }
  ...
  public tblnz_eotattributes with_fdtmFilingPeriod(java.sql.Timestamp fdtmFilingPeriod) {
    this.fdtmFilingPeriod = fdtmFilingPeriod;
    return this;
  }
  ...
  public tblnz_eotattributes with_fstrEOTType(String fstrEOTType) {
    this.fstrEOTType = fstrEOTType;
    return this;
  }
  ...
  public tblnz_eotattributes with_fstrStatus(String fstrStatus) {
    this.fstrStatus = fstrStatus;
    return this;
  }
  ...
  public tblnz_eotattributes with_fblnWithdrawnForLfp(Integer fblnWithdrawnForLfp) {
    this.fblnWithdrawnForLfp = fblnWithdrawnForLfp;
    return this;
  }
  ...
  public tblnz_eotattributes with_fblnManualOverride(Integer fblnManualOverride) {
    this.fblnManualOverride = fblnManualOverride;
    return this;
  }
  ...
  public tblnz_eotattributes with_fdtmDeferredDate(java.sql.Timestamp fdtmDeferredDate) {
    this.fdtmDeferredDate = fdtmDeferredDate;
    return this;
  }
  ...
  public tblnz_eotattributes with_fdtmExtensionDate(java.sql.Timestamp fdtmExtensionDate) {
    this.fdtmExtensionDate = fdtmExtensionDate;
    return this;
  }
  ...
  public tblnz_eotattributes with_fdtmTerminalTaxDue(java.sql.Timestamp fdtmTerminalTaxDue) {
    this.fdtmTerminalTaxDue = fdtmTerminalTaxDue;
    return this;
  }
  private java.sql.Timestamp fdtmReplicated;
  public java.sql.Timestamp get_fdtmReplicated() {
    return fdtmReplicated;
  }
  public void set_fdtmReplicated(java.sql.Timestamp fdtmReplicated) {
    this.fdtmReplicated = fdtmReplicated;
  }
  public tblnz_eotattributes with_fdtmReplicated(java.sql.Timestamp fdtmReplicated) {
    this.fdtmReplicated = fdtmReplicated;
    return this;
  }
  ...
  public tblnz_eotattributes with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_eotattributes with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_eotattributes)) {
      return false;
    }
    tblnz_eotattributes that = (tblnz_eotattributes) o;
    boolean equal = true;
    ...
    equal = equal && (this.fdtmReplicated == null ? that.fdtmReplicated == null : this.fdtmReplicated.equals(that.fdtmReplicated));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrAccountType = JdbcWritableBridge.readString(3, __dbResults);
    this.fdtmFilingPeriod = JdbcWritableBridge.readTimestamp(4, __dbResults);
    this.fstrEOTType = JdbcWritableBridge.readString(5, __dbResults);
    this.fstrStatus = JdbcWritableBridge.readString(6, __dbResults);
    this.fblnWithdrawnForLfp = JdbcWritableBridge.readInteger(7, __dbResults);
    this.fblnManualOverride = JdbcWritableBridge.readInteger(8, __dbResults);
    this.fdtmDeferredDate = JdbcWritableBridge.readTimestamp(9, __dbResults);
    this.fdtmExtensionDate = JdbcWritableBridge.readTimestamp(10, __dbResults);
    this.fdtmTerminalTaxDue = JdbcWritableBridge.readTimestamp(11, __dbResults);
    this.fdtmReplicated = JdbcWritableBridge.readTimestamp(12, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrAccountType, 3 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmFilingPeriod, 4 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(fstrEOTType, 5 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrStatus, 6 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnWithdrawnForLfp, 7 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnManualOverride, 8 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmDeferredDate, 9 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmExtensionDate, 10 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmTerminalTaxDue, 11 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmReplicated, 12 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fdtmReplicated = null;
    } else {
    this.fdtmReplicated = new Timestamp(__dataIn.readLong());
    this.fdtmReplicated.setNanos(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.fstrWho = null;
    } else {
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fdtmReplicated) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeLong(this.fdtmReplicated.getTime());
    __dataOut.writeInt(this.fdtmReplicated.getNanos());
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fdtmReplicated==null?"\\N":"" + fdtmReplicated, delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fdtmReplicated = null; } else {
      this.fdtmReplicated = java.sql.Timestamp.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_eotattributes o = (tblnz_eotattributes) super.clone();
    ...
    o.fdtmReplicated = (o.fdtmReplicated != null) ? (java.sql.Timestamp) o.fdtmReplicated.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
    return o;
  }

  public void clone0(tblnz_eotattributes o) throws CloneNotSupportedException {
    o.fdtmFilingPeriod = (o.fdtmFilingPeriod != null) ? (java.sql.Timestamp) o.fdtmFilingPeriod.clone() : null;
    o.fdtmDeferredDate = (o.fdtmDeferredDate != null) ? (java.sql.Timestamp) o.fdtmDeferredDate.clone() : null;
    o.fdtmExtensionDate = (o.fdtmExtensionDate != null) ? (java.sql.Timestamp) o.fdtmExtensionDate.clone() : null;
    o.fdtmTerminalTaxDue = (o.fdtmTerminalTaxDue != null) ? (java.sql.Timestamp) o.fdtmTerminalTaxDue.clone() : null;
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fdtmReplicated", this.fdtmReplicated);
