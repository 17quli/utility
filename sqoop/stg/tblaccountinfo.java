// ORM class for table 'tblaccountinfo'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:09:53 NZDT 2020
...
public class tblaccountinfo extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngAccountKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblaccountinfo.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fintParentProfileNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fintParentProfileNumber = (Integer)value;
      }
    });
    setters.put("fintProfileNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fintProfileNumber = (Integer)value;
      }
    });
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("flngJointCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.flngJointCustomerKey = (Integer)value;
      }
    });
    setters.put("flngJointAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.flngJointAccountKey = (Integer)value;
      }
    });
    setters.put("fblnPrime", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fblnPrime = (Integer)value;
      }
    });
    setters.put("fstrAccountType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrAccountType = (String)value;
      }
    });
    setters.put("flngDocKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("flngFolderKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.flngFolderKey = (Integer)value;
      }
    });
    setters.put("fstrFilingFrq", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrFilingFrq = (String)value;
      }
    });
    setters.put("fdtmCommence", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fdtmCommence = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCease", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fdtmCease = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCreated", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fdtmCreated = (java.sql.Timestamp)value;
      }
    });
    setters.put("fi64NameKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fi64NameKey = (Long)value;
      }
    });
    setters.put("fintNameKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fintNameKey = (Integer)value;
      }
    });
    setters.put("fstrDisplay", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrDisplay = (String)value;
      }
    });
    setters.put("fblnFormatted", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fblnFormatted = (Integer)value;
      }
    });
    setters.put("fstrNameType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrNameType = (String)value;
      }
    });
    setters.put("fstrFamilyName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrFamilyName = (String)value;
      }
    });
    setters.put("fstrMiddleName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrMiddleName = (String)value;
      }
    });
    setters.put("fstrFirstName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrFirstName = (String)value;
      }
    });
    setters.put("fstrNameControl", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrNameControl = (String)value;
      }
    });
    setters.put("fstrTitle", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrTitle = (String)value;
      }
    });
    setters.put("fstrSuffix", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrSuffix = (String)value;
      }
    });
    setters.put("fstrFreeFormatName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrFreeFormatName = (String)value;
      }
    });
    setters.put("fstrListFormatName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrListFormatName = (String)value;
      }
    });
    setters.put("fstrAdditionalName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrAdditionalName = (String)value;
      }
    });
    setters.put("fstrAdditionalName2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrAdditionalName2 = (String)value;
      }
    });
    setters.put("fi64AddressKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fi64AddressKey = (Long)value;
      }
    });
    setters.put("fintAddressKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fintAddressKey = (Integer)value;
      }
    });
    setters.put("fstrAddressType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrAddressType = (String)value;
      }
    });
    setters.put("fstrStreet", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrStreet = (String)value;
      }
    });
    setters.put("fstrStreet2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrStreet2 = (String)value;
      }
    });
    setters.put("fstrUnitType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrUnitType = (String)value;
      }
    });
    setters.put("fstrUnit", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrUnit = (String)value;
      }
    });
    setters.put("fstrCity", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCity = (String)value;
      }
    });
    setters.put("fstrCounty", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCounty = (String)value;
      }
    });
    setters.put("fstrState", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrState = (String)value;
      }
    });
    setters.put("fstrZip", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrZip = (String)value;
      }
    });
    setters.put("fstrDistrictOffice", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrDistrictOffice = (String)value;
      }
    });
    setters.put("fstrCountry", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCountry = (String)value;
      }
    });
    setters.put("fstrAttention", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrAttention = (String)value;
      }
    });
    setters.put("fstrLocationCode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrLocationCode = (String)value;
      }
    });
    setters.put("fstrUrbanization", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrUrbanization = (String)value;
      }
    });
    setters.put("fstrMunicipality", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrMunicipality = (String)value;
      }
    });
    setters.put("fstrDistrict", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrDistrict = (String)value;
      }
    });
    setters.put("fstrSubDistrict", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrSubDistrict = (String)value;
      }
    });
    setters.put("fstrSubProvince", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrSubProvince = (String)value;
      }
    });
    setters.put("fstrAddressDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrAddressDescription = (String)value;
      }
    });
    setters.put("fstrListFormatAddress", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrListFormatAddress = (String)value;
      }
    });
    setters.put("flngIDKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.flngIDKey = (Integer)value;
      }
    });
    setters.put("fstrIDType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrIDType = (String)value;
      }
    });
    setters.put("fstrID", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrID = (String)value;
      }
    });
    setters.put("fstrFormattedID", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrFormattedID = (String)value;
      }
    });
    setters.put("fstrCollectDistrictOffice", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCollectDistrictOffice = (String)value;
      }
    });
    setters.put("fstrCollectCity", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCollectCity = (String)value;
      }
    });
    setters.put("fstrCustomerType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCustomerType = (String)value;
      }
    });
    setters.put("fstrReviewType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrReviewType = (String)value;
      }
    });
    setters.put("fstrCustomerLevel", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fstrCustomerLevel = (String)value;
      }
    });
    setters.put("fi64ProtectedDataSource", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fi64ProtectedDataSource = (Long)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblaccountinfo.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  ...
  public tblaccountinfo with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  private Integer fintParentProfileNumber;
  public Integer get_fintParentProfileNumber() {
    return fintParentProfileNumber;
  }
  public void set_fintParentProfileNumber(Integer fintParentProfileNumber) {
    this.fintParentProfileNumber = fintParentProfileNumber;
  }
  public tblaccountinfo with_fintParentProfileNumber(Integer fintParentProfileNumber) {
    this.fintParentProfileNumber = fintParentProfileNumber;
    return this;
  }
  ...
  public tblaccountinfo with_fintProfileNumber(Integer fintProfileNumber) {
    this.fintProfileNumber = fintProfileNumber;
    return this;
  }
  ...
  public tblaccountinfo with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblaccountinfo with_flngJointCustomerKey(Integer flngJointCustomerKey) {
    this.flngJointCustomerKey = flngJointCustomerKey;
    return this;
  }
  ...
  public tblaccountinfo with_flngJointAccountKey(Integer flngJointAccountKey) {
    this.flngJointAccountKey = flngJointAccountKey;
    return this;
  }
  ...
  public tblaccountinfo with_fblnPrime(Integer fblnPrime) {
    this.fblnPrime = fblnPrime;
    return this;
  }
  ...
  public tblaccountinfo with_fstrAccountType(String fstrAccountType) {
    this.fstrAccountType = fstrAccountType;
    return this;
  }
  ...
  public tblaccountinfo with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblaccountinfo with_flngFolderKey(Integer flngFolderKey) {
    this.flngFolderKey = flngFolderKey;
    return this;
  }
  ...
  public tblaccountinfo with_fstrFilingFrq(String fstrFilingFrq) {
    this.fstrFilingFrq = fstrFilingFrq;
    return this;
  }
  ...
  public tblaccountinfo with_fdtmCommence(java.sql.Timestamp fdtmCommence) {
    this.fdtmCommence = fdtmCommence;
    return this;
  }
  ...
  public tblaccountinfo with_fdtmCease(java.sql.Timestamp fdtmCease) {
    this.fdtmCease = fdtmCease;
    return this;
  }
  ...
  public tblaccountinfo with_fdtmCreated(java.sql.Timestamp fdtmCreated) {
    this.fdtmCreated = fdtmCreated;
    return this;
  }
  ...
  public tblaccountinfo with_fi64NameKey(Long fi64NameKey) {
    this.fi64NameKey = fi64NameKey;
    return this;
  }
  ...
  public tblaccountinfo with_fintNameKey(Integer fintNameKey) {
    this.fintNameKey = fintNameKey;
    return this;
  }
  ...
  public tblaccountinfo with_fstrDisplay(String fstrDisplay) {
    this.fstrDisplay = fstrDisplay;
    return this;
  }
  ...
  public tblaccountinfo with_fblnFormatted(Integer fblnFormatted) {
    this.fblnFormatted = fblnFormatted;
    return this;
  }
  ...
  public tblaccountinfo with_fstrNameType(String fstrNameType) {
    this.fstrNameType = fstrNameType;
    return this;
  }
  ...
  public tblaccountinfo with_fstrFamilyName(String fstrFamilyName) {
    this.fstrFamilyName = fstrFamilyName;
    return this;
  }
  ...
  public tblaccountinfo with_fstrMiddleName(String fstrMiddleName) {
    this.fstrMiddleName = fstrMiddleName;
    return this;
  }
  ...
  public tblaccountinfo with_fstrFirstName(String fstrFirstName) {
    this.fstrFirstName = fstrFirstName;
    return this;
  }
  ...
  public tblaccountinfo with_fstrNameControl(String fstrNameControl) {
    this.fstrNameControl = fstrNameControl;
    return this;
  }
  ...
  public tblaccountinfo with_fstrTitle(String fstrTitle) {
    this.fstrTitle = fstrTitle;
    return this;
  }
  ...
  public tblaccountinfo with_fstrSuffix(String fstrSuffix) {
    this.fstrSuffix = fstrSuffix;
    return this;
  }
  ...
  public tblaccountinfo with_fstrFreeFormatName(String fstrFreeFormatName) {
    this.fstrFreeFormatName = fstrFreeFormatName;
    return this;
  }
  ...
  public tblaccountinfo with_fstrListFormatName(String fstrListFormatName) {
    this.fstrListFormatName = fstrListFormatName;
    return this;
  }
  ...
  public tblaccountinfo with_fstrAdditionalName(String fstrAdditionalName) {
    this.fstrAdditionalName = fstrAdditionalName;
    return this;
  }
  ...
  public tblaccountinfo with_fstrAdditionalName2(String fstrAdditionalName2) {
    this.fstrAdditionalName2 = fstrAdditionalName2;
    return this;
  }
  ...
  public tblaccountinfo with_fi64AddressKey(Long fi64AddressKey) {
    this.fi64AddressKey = fi64AddressKey;
    return this;
  }
  ...
  public tblaccountinfo with_fintAddressKey(Integer fintAddressKey) {
    this.fintAddressKey = fintAddressKey;
    return this;
  }
  ...
  public tblaccountinfo with_fstrAddressType(String fstrAddressType) {
    this.fstrAddressType = fstrAddressType;
    return this;
  }
  ...
  public tblaccountinfo with_fstrStreet(String fstrStreet) {
    this.fstrStreet = fstrStreet;
    return this;
  }
  ...
  public tblaccountinfo with_fstrStreet2(String fstrStreet2) {
    this.fstrStreet2 = fstrStreet2;
    return this;
  }
  ...
  public tblaccountinfo with_fstrUnitType(String fstrUnitType) {
    this.fstrUnitType = fstrUnitType;
    return this;
  }
  ...
  public tblaccountinfo with_fstrUnit(String fstrUnit) {
    this.fstrUnit = fstrUnit;
    return this;
  }
  ...
  public tblaccountinfo with_fstrCity(String fstrCity) {
    this.fstrCity = fstrCity;
    return this;
  }
  ...
  public tblaccountinfo with_fstrCounty(String fstrCounty) {
    this.fstrCounty = fstrCounty;
    return this;
  }
  ...
  public tblaccountinfo with_fstrState(String fstrState) {
    this.fstrState = fstrState;
    return this;
  }
  ...
  public tblaccountinfo with_fstrZip(String fstrZip) {
    this.fstrZip = fstrZip;
    return this;
  }
  ...
  public tblaccountinfo with_fstrDistrictOffice(String fstrDistrictOffice) {
    this.fstrDistrictOffice = fstrDistrictOffice;
    return this;
  }
  ...
  public tblaccountinfo with_fstrCountry(String fstrCountry) {
    this.fstrCountry = fstrCountry;
    return this;
  }
  ...
  public tblaccountinfo with_fstrAttention(String fstrAttention) {
    this.fstrAttention = fstrAttention;
    return this;
  }
  ...
  public tblaccountinfo with_fstrLocationCode(String fstrLocationCode) {
    this.fstrLocationCode = fstrLocationCode;
    return this;
  }
  ...
  public tblaccountinfo with_fstrUrbanization(String fstrUrbanization) {
    this.fstrUrbanization = fstrUrbanization;
    return this;
  }
  ...
  public tblaccountinfo with_fstrMunicipality(String fstrMunicipality) {
    this.fstrMunicipality = fstrMunicipality;
    return this;
  }
  ...
  public tblaccountinfo with_fstrDistrict(String fstrDistrict) {
    this.fstrDistrict = fstrDistrict;
    return this;
  }
  ...
  public tblaccountinfo with_fstrSubDistrict(String fstrSubDistrict) {
    this.fstrSubDistrict = fstrSubDistrict;
    return this;
  }
  ...
  public tblaccountinfo with_fstrSubProvince(String fstrSubProvince) {
    this.fstrSubProvince = fstrSubProvince;
    return this;
  }
  ...
  public tblaccountinfo with_fstrAddressDescription(String fstrAddressDescription) {
    this.fstrAddressDescription = fstrAddressDescription;
    return this;
  }
  ...
  public tblaccountinfo with_fstrListFormatAddress(String fstrListFormatAddress) {
    this.fstrListFormatAddress = fstrListFormatAddress;
    return this;
  }
  ...
  public tblaccountinfo with_flngIDKey(Integer flngIDKey) {
    this.flngIDKey = flngIDKey;
    return this;
  }
  ...
  public tblaccountinfo with_fstrIDType(String fstrIDType) {
    this.fstrIDType = fstrIDType;
    return this;
  }
  ...
  public tblaccountinfo with_fstrID(String fstrID) {
    this.fstrID = fstrID;
    return this;
  }
  ...
  public tblaccountinfo with_fstrFormattedID(String fstrFormattedID) {
    this.fstrFormattedID = fstrFormattedID;
    return this;
  }
  ...
  public tblaccountinfo with_fstrCollectDistrictOffice(String fstrCollectDistrictOffice) {
    this.fstrCollectDistrictOffice = fstrCollectDistrictOffice;
    return this;
  }
  private String fstrCollectCity;
  public String get_fstrCollectCity() {
    return fstrCollectCity;
  }
  public void set_fstrCollectCity(String fstrCollectCity) {
    this.fstrCollectCity = fstrCollectCity;
  }
  public tblaccountinfo with_fstrCollectCity(String fstrCollectCity) {
    this.fstrCollectCity = fstrCollectCity;
    return this;
  }
  ...
  public tblaccountinfo with_fstrCustomerType(String fstrCustomerType) {
    this.fstrCustomerType = fstrCustomerType;
    return this;
  }
  ...
  public tblaccountinfo with_fstrReviewType(String fstrReviewType) {
    this.fstrReviewType = fstrReviewType;
    return this;
  }
  ...
  public tblaccountinfo with_fstrCustomerLevel(String fstrCustomerLevel) {
    this.fstrCustomerLevel = fstrCustomerLevel;
    return this;
  }
  ...
  public tblaccountinfo with_fi64ProtectedDataSource(Long fi64ProtectedDataSource) {
    this.fi64ProtectedDataSource = fi64ProtectedDataSource;
    return this;
  }
  ...
  public tblaccountinfo with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblaccountinfo)) {
      return false;
    }
    tblaccountinfo that = (tblaccountinfo) o;
    boolean equal = true;
    equal = equal && (this.flngAccountKey == null ? that.flngAccountKey == null : this.flngAccountKey.equals(that.flngAccountKey));
    equal = equal && (this.fintParentProfileNumber == null ? that.fintParentProfileNumber == null : this.fintParentProfileNumber.equals(that.fintParentProfileNumber));
    ...
    equal = equal && (this.fstrCollectCity == null ? that.fstrCollectCity == null : this.fstrCollectCity.equals(that.fstrCollectCity));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fintParentProfileNumber = JdbcWritableBridge.readInteger(2, __dbResults);
    this.fintProfileNumber = JdbcWritableBridge.readInteger(3, __dbResults);
    this.flngCustomerKey = JdbcWritableBridge.readInteger(4, __dbResults);
    this.flngJointCustomerKey = JdbcWritableBridge.readInteger(5, __dbResults);
    ...
    this.fstrAccountType = JdbcWritableBridge.readString(8, __dbResults);
    this.flngDocKey = JdbcWritableBridge.readInteger(9, __dbResults);
    this.flngFolderKey = JdbcWritableBridge.readInteger(10, __dbResults);
    this.fstrFilingFrq = JdbcWritableBridge.readString(11, __dbResults);
    ...
    this.fi64NameKey = JdbcWritableBridge.readLong(15, __dbResults);
    this.fintNameKey = JdbcWritableBridge.readInteger(16, __dbResults);
    this.fstrDisplay = JdbcWritableBridge.readString(17, __dbResults);
    this.fblnFormatted = JdbcWritableBridge.readInteger(18, __dbResults);
    this.fstrNameType = JdbcWritableBridge.readString(19, __dbResults);
    this.fstrFamilyName = JdbcWritableBridge.readString(20, __dbResults);
    this.fstrMiddleName = JdbcWritableBridge.readString(21, __dbResults);
    this.fstrFirstName = JdbcWritableBridge.readString(22, __dbResults);
    this.fstrNameControl = JdbcWritableBridge.readString(23, __dbResults);
    this.fstrTitle = JdbcWritableBridge.readString(24, __dbResults);
    this.fstrSuffix = JdbcWritableBridge.readString(25, __dbResults);
    this.fstrFreeFormatName = JdbcWritableBridge.readString(26, __dbResults);
    this.fstrListFormatName = JdbcWritableBridge.readString(27, __dbResults);
    this.fstrAdditionalName = JdbcWritableBridge.readString(28, __dbResults);
    this.fstrAdditionalName2 = JdbcWritableBridge.readString(29, __dbResults);
    this.fi64AddressKey = JdbcWritableBridge.readLong(30, __dbResults);
    this.fintAddressKey = JdbcWritableBridge.readInteger(31, __dbResults);
    this.fstrAddressType = JdbcWritableBridge.readString(32, __dbResults);
    this.fstrStreet = JdbcWritableBridge.readString(33, __dbResults);
    this.fstrStreet2 = JdbcWritableBridge.readString(34, __dbResults);
    this.fstrUnitType = JdbcWritableBridge.readString(35, __dbResults);
    this.fstrUnit = JdbcWritableBridge.readString(36, __dbResults);
    this.fstrCity = JdbcWritableBridge.readString(37, __dbResults);
    this.fstrCounty = JdbcWritableBridge.readString(38, __dbResults);
    this.fstrState = JdbcWritableBridge.readString(39, __dbResults);
    this.fstrZip = JdbcWritableBridge.readString(40, __dbResults);
    this.fstrDistrictOffice = JdbcWritableBridge.readString(41, __dbResults);
    this.fstrCountry = JdbcWritableBridge.readString(42, __dbResults);
    this.fstrAttention = JdbcWritableBridge.readString(43, __dbResults);
    this.fstrLocationCode = JdbcWritableBridge.readString(44, __dbResults);
    this.fstrUrbanization = JdbcWritableBridge.readString(45, __dbResults);
    this.fstrMunicipality = JdbcWritableBridge.readString(46, __dbResults);
    this.fstrDistrict = JdbcWritableBridge.readString(47, __dbResults);
    this.fstrSubDistrict = JdbcWritableBridge.readString(48, __dbResults);
    this.fstrSubProvince = JdbcWritableBridge.readString(49, __dbResults);
    this.fstrAddressDescription = JdbcWritableBridge.readString(50, __dbResults);
    this.fstrListFormatAddress = JdbcWritableBridge.readString(51, __dbResults);
    this.flngIDKey = JdbcWritableBridge.readInteger(52, __dbResults);
    this.fstrIDType = JdbcWritableBridge.readString(53, __dbResults);
    this.fstrID = JdbcWritableBridge.readString(54, __dbResults);
    this.fstrFormattedID = JdbcWritableBridge.readString(55, __dbResults);
    this.fstrCollectDistrictOffice = JdbcWritableBridge.readString(56, __dbResults);
    this.fstrCollectCity = JdbcWritableBridge.readString(57, __dbResults);
    this.fstrCustomerType = JdbcWritableBridge.readString(58, __dbResults);
    this.fstrReviewType = JdbcWritableBridge.readString(59, __dbResults);
    this.fstrCustomerLevel = JdbcWritableBridge.readString(60, __dbResults);
    this.fi64ProtectedDataSource = JdbcWritableBridge.readLong(61, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(fintParentProfileNumber, 2 + __off, 5, __dbStmt);
    JdbcWritableBridge.writeInteger(fintProfileNumber, 3 + __off, 5, __dbStmt);
    JdbcWritableBridge.writeInteger(flngCustomerKey, 4 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngJointCustomerKey, 5 + __off, 4, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrAccountType, 8 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(flngDocKey, 9 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngFolderKey, 10 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(fstrFilingFrq, 11 + __off, -9, __dbStmt);
    ...
    JdbcWritableBridge.writeLong(fi64NameKey, 15 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeInteger(fintNameKey, 16 + __off, 5, __dbStmt);
    JdbcWritableBridge.writeString(fstrDisplay, 17 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnFormatted, 18 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeString(fstrNameType, 19 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrFamilyName, 20 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrMiddleName, 21 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrFirstName, 22 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrNameControl, 23 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrTitle, 24 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrSuffix, 25 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrFreeFormatName, 26 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrListFormatName, 27 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrAdditionalName, 28 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrAdditionalName2, 29 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeLong(fi64AddressKey, 30 + __off, -5, __dbStmt);
    JdbcWritableBridge.writeInteger(fintAddressKey, 31 + __off, 5, __dbStmt);
    JdbcWritableBridge.writeString(fstrAddressType, 32 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrStreet, 33 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrStreet2, 34 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrUnitType, 35 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrUnit, 36 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCity, 37 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCounty, 38 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrState, 39 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrZip, 40 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrDistrictOffice, 41 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCountry, 42 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrAttention, 43 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrLocationCode, 44 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrUrbanization, 45 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrMunicipality, 46 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrDistrict, 47 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrSubDistrict, 48 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrSubProvince, 49 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrAddressDescription, 50 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrListFormatAddress, 51 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(flngIDKey, 52 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(fstrIDType, 53 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrID, 54 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrFormattedID, 55 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCollectDistrictOffice, 56 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCollectCity, 57 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCustomerType, 58 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrReviewType, 59 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrCustomerLevel, 60 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeLong(fi64ProtectedDataSource, 61 + __off, -5, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fintParentProfileNumber = null;
    } else {
    this.fintParentProfileNumber = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrCollectCity = null;
    } else {
    this.fstrCollectCity = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fintParentProfileNumber) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.fintParentProfileNumber);
    }
    ...
    if (null == this.fstrCollectCity) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrCollectCity);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(fintParentProfileNumber==null?"\\N":"" + fintParentProfileNumber, delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrCollectCity==null?"\\N":fstrCollectCity, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fintParentProfileNumber = null; } else {
      this.fintParentProfileNumber = Integer.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null")) { this.fstrCollectCity = null; } else {
      this.fstrCollectCity = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblaccountinfo o = (tblaccountinfo) super.clone();
  ...
  public void clone0(tblaccountinfo o) throws CloneNotSupportedException {
    o.fdtmCommence = (o.fdtmCommence != null) ? (java.sql.Timestamp) o.fdtmCommence.clone() : null;
    o.fdtmCease = (o.fdtmCease != null) ? (java.sql.Timestamp) o.fdtmCease.clone() : null;
    o.fdtmCreated = (o.fdtmCreated != null) ? (java.sql.Timestamp) o.fdtmCreated.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fintParentProfileNumber", this.fintParentProfileNumber);
    ...
    __sqoop$field_map.put("fstrCollectCity", this.fstrCollectCity);
