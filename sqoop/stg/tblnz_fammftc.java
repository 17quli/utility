// ORM class for table 'tblnz_fammftc'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 04:35:02 NZDT 2020
...
public class tblnz_fammftc extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngFAMWorkKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_fammftc.this.flngFAMWorkKey = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("fdtmStart", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.fdtmStart = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmStop", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.fdtmStop = (java.sql.Timestamp)value;
      }
    });
    setters.put("fblnSharedCare", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.fblnSharedCare = (Integer)value;
      }
    });
    setters.put("fblnActive", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.fblnActive = (Integer)value;
      }
    });
    setters.put("flngAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_fammftc.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_fammftc() {
    init0();
  }
  ...
  public tblnz_fammftc with_flngFAMWorkKey(Integer flngFAMWorkKey) {
    this.flngFAMWorkKey = flngFAMWorkKey;
    return this;
  }
  ...
  public tblnz_fammftc with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblnz_fammftc with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblnz_fammftc with_fdtmStart(java.sql.Timestamp fdtmStart) {
    this.fdtmStart = fdtmStart;
    return this;
  }
  ...
  public tblnz_fammftc with_fdtmStop(java.sql.Timestamp fdtmStop) {
    this.fdtmStop = fdtmStop;
    return this;
  }
  private Integer fblnSharedCare;
  public Integer get_fblnSharedCare() {
    return fblnSharedCare;
  }
  public void set_fblnSharedCare(Integer fblnSharedCare) {
    this.fblnSharedCare = fblnSharedCare;
  }
  public tblnz_fammftc with_fblnSharedCare(Integer fblnSharedCare) {
    this.fblnSharedCare = fblnSharedCare;
    return this;
  }
  ...
  public tblnz_fammftc with_fblnActive(Integer fblnActive) {
    this.fblnActive = fblnActive;
    return this;
  }
  ...
  public tblnz_fammftc with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  ...
  public tblnz_fammftc with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_fammftc with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_fammftc)) {
      return false;
    }
    tblnz_fammftc that = (tblnz_fammftc) o;
    boolean equal = true;
    ...
    equal = equal && (this.fblnSharedCare == null ? that.fblnSharedCare == null : this.fblnSharedCare.equals(that.fblnSharedCare));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fblnSharedCare = JdbcWritableBridge.readInteger(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(fblnSharedCare, 6 + __off, -6, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fblnSharedCare = null;
    } else {
    this.fblnSharedCare = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fblnSharedCare) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.fblnSharedCare);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fblnSharedCare==null?"\\N":"" + fblnSharedCare, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fblnSharedCare = null; } else {
      this.fblnSharedCare = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_fammftc o = (tblnz_fammftc) super.clone();
  ...
  public void clone0(tblnz_fammftc o) throws CloneNotSupportedException {
    o.fdtmStart = (o.fdtmStart != null) ? (java.sql.Timestamp) o.fdtmStart.clone() : null;
    o.fdtmStop = (o.fdtmStop != null) ? (java.sql.Timestamp) o.fdtmStop.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fblnSharedCare", this.fblnSharedCare);
