// ORM class for table 'tblnz_rtnfbtqtr'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:59:29 NZDT 2020
...
public class tblnz_rtnfbtqtr extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngDocKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("fcurTaxableBenefits", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fcurTaxableBenefits = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurFBTTaxRate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fcurFBTTaxRate = (java.math.BigDecimal)value;
      }
    });
    setters.put("fblnAlternateRate1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fblnAlternateRate1 = (Integer)value;
      }
    });
    setters.put("fblnAlternateRate2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fblnAlternateRate2 = (Integer)value;
      }
    });
    setters.put("fcurFringeTaxCalculation", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fcurFringeTaxCalculation = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurExemptFringeBenefits", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fcurExemptFringeBenefits = (java.math.BigDecimal)value;
      }
    });
    setters.put("fblnGSTAmend", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fblnGSTAmend = (Integer)value;
      }
    });
    setters.put("fcurGSTPayable", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fcurGSTPayable = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurTotalAmount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fcurTotalAmount = (java.math.BigDecimal)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfbtqtr.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_rtnfbtqtr() {
    init0();
  }
  ...
  public tblnz_rtnfbtqtr with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fcurTaxableBenefits(java.math.BigDecimal fcurTaxableBenefits) {
    this.fcurTaxableBenefits = fcurTaxableBenefits;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fcurFBTTaxRate(java.math.BigDecimal fcurFBTTaxRate) {
    this.fcurFBTTaxRate = fcurFBTTaxRate;
    return this;
  }
  private Integer fblnAlternateRate1;
  public Integer get_fblnAlternateRate1() {
    return fblnAlternateRate1;
  }
  public void set_fblnAlternateRate1(Integer fblnAlternateRate1) {
    this.fblnAlternateRate1 = fblnAlternateRate1;
  }
  public tblnz_rtnfbtqtr with_fblnAlternateRate1(Integer fblnAlternateRate1) {
    this.fblnAlternateRate1 = fblnAlternateRate1;
    return this;
  }
  private Integer fblnAlternateRate2;
  public Integer get_fblnAlternateRate2() {
    return fblnAlternateRate2;
  }
  public void set_fblnAlternateRate2(Integer fblnAlternateRate2) {
    this.fblnAlternateRate2 = fblnAlternateRate2;
  }
  public tblnz_rtnfbtqtr with_fblnAlternateRate2(Integer fblnAlternateRate2) {
    this.fblnAlternateRate2 = fblnAlternateRate2;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fcurFringeTaxCalculation(java.math.BigDecimal fcurFringeTaxCalculation) {
    this.fcurFringeTaxCalculation = fcurFringeTaxCalculation;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fcurExemptFringeBenefits(java.math.BigDecimal fcurExemptFringeBenefits) {
    this.fcurExemptFringeBenefits = fcurExemptFringeBenefits;
    return this;
  }
  private Integer fblnGSTAmend;
  public Integer get_fblnGSTAmend() {
    return fblnGSTAmend;
  }
  public void set_fblnGSTAmend(Integer fblnGSTAmend) {
    this.fblnGSTAmend = fblnGSTAmend;
  }
  public tblnz_rtnfbtqtr with_fblnGSTAmend(Integer fblnGSTAmend) {
    this.fblnGSTAmend = fblnGSTAmend;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fcurGSTPayable(java.math.BigDecimal fcurGSTPayable) {
    this.fcurGSTPayable = fcurGSTPayable;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fcurTotalAmount(java.math.BigDecimal fcurTotalAmount) {
    this.fcurTotalAmount = fcurTotalAmount;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_rtnfbtqtr with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_rtnfbtqtr)) {
      return false;
    }
    tblnz_rtnfbtqtr that = (tblnz_rtnfbtqtr) o;
    boolean equal = true;
    ...
    equal = equal && (this.fblnAlternateRate1 == null ? that.fblnAlternateRate1 == null : this.fblnAlternateRate1.equals(that.fblnAlternateRate1));
    equal = equal && (this.fblnAlternateRate2 == null ? that.fblnAlternateRate2 == null : this.fblnAlternateRate2.equals(that.fblnAlternateRate2));
    ...
    equal = equal && (this.fblnGSTAmend == null ? that.fblnGSTAmend == null : this.fblnGSTAmend.equals(that.fblnGSTAmend));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fblnAlternateRate1 = JdbcWritableBridge.readInteger(4, __dbResults);
    this.fblnAlternateRate2 = JdbcWritableBridge.readInteger(5, __dbResults);
    this.fcurFringeTaxCalculation = JdbcWritableBridge.readBigDecimal(6, __dbResults);
    this.fcurExemptFringeBenefits = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.fblnGSTAmend = JdbcWritableBridge.readInteger(8, __dbResults);
    this.fcurGSTPayable = JdbcWritableBridge.readBigDecimal(9, __dbResults);
    this.fcurTotalAmount = JdbcWritableBridge.readBigDecimal(10, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(fblnAlternateRate1, 4 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnAlternateRate2, 5 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurFringeTaxCalculation, 6 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurExemptFringeBenefits, 7 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnGSTAmend, 8 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurGSTPayable, 9 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurTotalAmount, 10 + __off, 3, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fblnAlternateRate1 = null;
    } else {
    this.fblnAlternateRate1 = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.fblnAlternateRate2 = null;
    } else {
    this.fblnAlternateRate2 = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.fblnGSTAmend = null;
    } else {
    this.fblnGSTAmend = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fblnAlternateRate1) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.fblnAlternateRate1);
    }
    if (null == this.fblnAlternateRate2) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.fblnAlternateRate2);
    }
    ...
    if (null == this.fblnGSTAmend) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.fblnGSTAmend);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fblnAlternateRate1==null?"\\N":"" + fblnAlternateRate1, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fblnAlternateRate2==null?"\\N":"" + fblnAlternateRate2, delimiters));
    __sb.append(fieldDelim);
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fblnGSTAmend==null?"\\N":"" + fblnGSTAmend, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fblnAlternateRate1 = null; } else {
      this.fblnAlternateRate1 = Integer.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fblnAlternateRate2 = null; } else {
      this.fblnAlternateRate2 = Integer.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fblnGSTAmend = null; } else {
      this.fblnGSTAmend = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_rtnfbtqtr o = (tblnz_rtnfbtqtr) super.clone();
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
    return o;
  }

  public void clone0(tblnz_rtnfbtqtr o) throws CloneNotSupportedException {
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fblnAlternateRate1", this.fblnAlternateRate1);
    __sqoop$field_map.put("fblnAlternateRate2", this.fblnAlternateRate2);
    ...
    __sqoop$field_map.put("fblnGSTAmend", this.fblnGSTAmend);
