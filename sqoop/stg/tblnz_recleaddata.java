// ORM class for table 'tblnz_recleaddata'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 05:54:28 NZDT 2020
...
public class tblnz_recleaddata extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngDataKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_recleaddata.this.flngDataKey = (Integer)value;
      }
    });
    setters.put("flngParentKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.flngParentKey = (Integer)value;
      }
    });
    setters.put("fdtmBegin", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fdtmBegin = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmEnd", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fdtmEnd = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrRecoveryGroup", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrRecoveryGroup = (String)value;
      }
    });
    setters.put("fstrOwner", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrOwner = (String)value;
      }
    });
    setters.put("fstrManager", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrManager = (String)value;
      }
    });
    setters.put("fstrDistrictOffice", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrDistrictOffice = (String)value;
      }
    });
    setters.put("fstrType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrType = (String)value;
      }
    });
    setters.put("fstrStage", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrStage = (String)value;
      }
    });
    setters.put("fstrLeadCategory", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrLeadCategory = (String)value;
      }
    });
    setters.put("fstrLeadWorkArea", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrLeadWorkArea = (String)value;
      }
    });
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("flngAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fdtmFilingPeriod", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fdtmFilingPeriod = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrNextAction", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrNextAction = (String)value;
      }
    });
    setters.put("fdtmNextActionDue", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fdtmNextActionDue = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_recleaddata.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_recleaddata() {
    init0();
  }
  ...
  public tblnz_recleaddata with_flngDataKey(Integer flngDataKey) {
    this.flngDataKey = flngDataKey;
    return this;
  }
  ...
  public tblnz_recleaddata with_flngParentKey(Integer flngParentKey) {
    this.flngParentKey = flngParentKey;
    return this;
  }
  ...
  public tblnz_recleaddata with_fdtmBegin(java.sql.Timestamp fdtmBegin) {
    this.fdtmBegin = fdtmBegin;
    return this;
  }
  ...
  public tblnz_recleaddata with_fdtmEnd(java.sql.Timestamp fdtmEnd) {
    this.fdtmEnd = fdtmEnd;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrRecoveryGroup(String fstrRecoveryGroup) {
    this.fstrRecoveryGroup = fstrRecoveryGroup;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrOwner(String fstrOwner) {
    this.fstrOwner = fstrOwner;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrManager(String fstrManager) {
    this.fstrManager = fstrManager;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrDistrictOffice(String fstrDistrictOffice) {
    this.fstrDistrictOffice = fstrDistrictOffice;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrType(String fstrType) {
    this.fstrType = fstrType;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrStage(String fstrStage) {
    this.fstrStage = fstrStage;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrLeadCategory(String fstrLeadCategory) {
    this.fstrLeadCategory = fstrLeadCategory;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrLeadWorkArea(String fstrLeadWorkArea) {
    this.fstrLeadWorkArea = fstrLeadWorkArea;
    return this;
  }
  ...
  public tblnz_recleaddata with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblnz_recleaddata with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  ...
  public tblnz_recleaddata with_fdtmFilingPeriod(java.sql.Timestamp fdtmFilingPeriod) {
    this.fdtmFilingPeriod = fdtmFilingPeriod;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrNextAction(String fstrNextAction) {
    this.fstrNextAction = fstrNextAction;
    return this;
  }
  ...
  public tblnz_recleaddata with_fdtmNextActionDue(java.sql.Timestamp fdtmNextActionDue) {
    this.fdtmNextActionDue = fdtmNextActionDue;
    return this;
  }
  ...
  public tblnz_recleaddata with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_recleaddata with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_recleaddata)) {
      return false;
    }
    tblnz_recleaddata that = (tblnz_recleaddata) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrLeadCategory = JdbcWritableBridge.readString(11, __dbResults);
    this.fstrLeadWorkArea = JdbcWritableBridge.readString(12, __dbResults);
    this.flngCustomerKey = JdbcWritableBridge.readInteger(13, __dbResults);
    this.flngAccountKey = JdbcWritableBridge.readInteger(14, __dbResults);
    this.fdtmFilingPeriod = JdbcWritableBridge.readTimestamp(15, __dbResults);
    this.fstrNextAction = JdbcWritableBridge.readString(16, __dbResults);
    this.fdtmNextActionDue = JdbcWritableBridge.readTimestamp(17, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrLeadCategory, 11 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrLeadWorkArea, 12 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(flngCustomerKey, 13 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngAccountKey, 14 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmFilingPeriod, 15 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeString(fstrNextAction, 16 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmNextActionDue, 17 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_recleaddata o = (tblnz_recleaddata) super.clone();
  ...
  public void clone0(tblnz_recleaddata o) throws CloneNotSupportedException {
    o.fdtmBegin = (o.fdtmBegin != null) ? (java.sql.Timestamp) o.fdtmBegin.clone() : null;
    o.fdtmEnd = (o.fdtmEnd != null) ? (java.sql.Timestamp) o.fdtmEnd.clone() : null;
    o.fdtmFilingPeriod = (o.fdtmFilingPeriod != null) ? (java.sql.Timestamp) o.fdtmFilingPeriod.clone() : null;
    o.fdtmNextActionDue = (o.fdtmNextActionDue != null) ? (java.sql.Timestamp) o.fdtmNextActionDue.clone() : null;
