// ORM class for table 'lanwebreqstatus'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:04:14 NZDT 2020
...
public class lanwebreqstatus extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanwebreqstatus.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrWebReqStatus", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqstatus.this.fstrWebReqStatus = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqstatus.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqstatus.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqstatus.this.fstrDescription = (String)value;
      }
    });
  }
  public lanwebreqstatus() {
    init0();
  }
  ...
  public lanwebreqstatus with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrWebReqStatus;
  public String get_fstrWebReqStatus() {
    return fstrWebReqStatus;
  }
  public void set_fstrWebReqStatus(String fstrWebReqStatus) {
    this.fstrWebReqStatus = fstrWebReqStatus;
  }
  public lanwebreqstatus with_fstrWebReqStatus(String fstrWebReqStatus) {
    this.fstrWebReqStatus = fstrWebReqStatus;
    return this;
  }
  ...
  public lanwebreqstatus with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanwebreqstatus with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanwebreqstatus with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanwebreqstatus)) {
      return false;
    }
    lanwebreqstatus that = (lanwebreqstatus) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrWebReqStatus == null ? that.fstrWebReqStatus == null : this.fstrWebReqStatus.equals(that.fstrWebReqStatus));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrWebReqStatus = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrWebReqStatus, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrWebReqStatus = null;
    } else {
    this.fstrWebReqStatus = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrWebReqStatus) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrWebReqStatus);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrWebReqStatus==null?"\\N":fstrWebReqStatus, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrWebReqStatus = null; } else {
      this.fstrWebReqStatus = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanwebreqstatus o = (lanwebreqstatus) super.clone();
    return o;
  }

  public void clone0(lanwebreqstatus o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrWebReqStatus", this.fstrWebReqStatus);
