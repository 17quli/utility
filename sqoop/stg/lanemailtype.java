// ORM class for table 'lanemailtype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:07:43 NZDT 2020
...
public class lanemailtype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanemailtype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrEmailType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanemailtype.this.fstrEmailType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanemailtype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanemailtype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanemailtype.this.fstrDescription = (String)value;
      }
    });
  }
  public lanemailtype() {
  ...
  public lanemailtype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrEmailType;
  public String get_fstrEmailType() {
    return fstrEmailType;
  }
  public void set_fstrEmailType(String fstrEmailType) {
    this.fstrEmailType = fstrEmailType;
  }
  public lanemailtype with_fstrEmailType(String fstrEmailType) {
    this.fstrEmailType = fstrEmailType;
    return this;
  }
  ...
  public lanemailtype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanemailtype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanemailtype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanemailtype)) {
      return false;
    }
    lanemailtype that = (lanemailtype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrEmailType == null ? that.fstrEmailType == null : this.fstrEmailType.equals(that.fstrEmailType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrEmailType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrEmailType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrEmailType = null;
    } else {
    this.fstrEmailType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrEmailType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrEmailType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrEmailType==null?"\\N":fstrEmailType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrEmailType = null; } else {
      this.fstrEmailType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanemailtype o = (lanemailtype) super.clone();
    return o;
  }

  public void clone0(lanemailtype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrEmailType", this.fstrEmailType);
