// ORM class for table 'lanindicatorlevel'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:20:13 NZDT 2020
...
public class lanindicatorlevel extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanindicatorlevel.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrIndicatorLevel", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorlevel.this.fstrIndicatorLevel = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorlevel.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorlevel.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorlevel.this.fstrDescription = (String)value;
      }
    });
  }
  public lanindicatorlevel() {
    init0();
  }
  ...
  public lanindicatorlevel with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrIndicatorLevel;
  public String get_fstrIndicatorLevel() {
    return fstrIndicatorLevel;
  }
  public void set_fstrIndicatorLevel(String fstrIndicatorLevel) {
    this.fstrIndicatorLevel = fstrIndicatorLevel;
  }
  public lanindicatorlevel with_fstrIndicatorLevel(String fstrIndicatorLevel) {
    this.fstrIndicatorLevel = fstrIndicatorLevel;
    return this;
  }
  ...
  public lanindicatorlevel with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanindicatorlevel with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanindicatorlevel with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanindicatorlevel)) {
      return false;
    }
    lanindicatorlevel that = (lanindicatorlevel) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrIndicatorLevel == null ? that.fstrIndicatorLevel == null : this.fstrIndicatorLevel.equals(that.fstrIndicatorLevel));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrIndicatorLevel = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrIndicatorLevel, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrIndicatorLevel = null;
    } else {
    this.fstrIndicatorLevel = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrIndicatorLevel) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrIndicatorLevel);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrIndicatorLevel==null?"\\N":fstrIndicatorLevel, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrIndicatorLevel = null; } else {
      this.fstrIndicatorLevel = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanindicatorlevel o = (lanindicatorlevel) super.clone();
    return o;
  }

  public void clone0(lanindicatorlevel o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrIndicatorLevel", this.fstrIndicatorLevel);
