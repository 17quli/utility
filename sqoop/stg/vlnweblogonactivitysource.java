// ORM class for table 'vlnweblogonactivitysource'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:59:15 NZDT 2020
...
public class vlnweblogonactivitysource extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        vlnweblogonactivitysource.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrSource", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        vlnweblogonactivitysource.this.fstrSource = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        vlnweblogonactivitysource.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        vlnweblogonactivitysource.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        vlnweblogonactivitysource.this.fstrDescription = (String)value;
      }
    });
    setters.put("fstrRowSource", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        vlnweblogonactivitysource.this.fstrRowSource = (String)value;
      }
    });
  }
  public vlnweblogonactivitysource() {
    init0();
  }
  ...
  public vlnweblogonactivitysource with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public vlnweblogonactivitysource with_fstrSource(String fstrSource) {
    this.fstrSource = fstrSource;
    return this;
  }
  ...
  public vlnweblogonactivitysource with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public vlnweblogonactivitysource with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public vlnweblogonactivitysource with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  private String fstrRowSource;
  public String get_fstrRowSource() {
    return fstrRowSource;
  }
  public void set_fstrRowSource(String fstrRowSource) {
    this.fstrRowSource = fstrRowSource;
  }
  public vlnweblogonactivitysource with_fstrRowSource(String fstrRowSource) {
    this.fstrRowSource = fstrRowSource;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof vlnweblogonactivitysource)) {
      return false;
    }
    vlnweblogonactivitysource that = (vlnweblogonactivitysource) o;
    boolean equal = true;
    ...
    equal = equal && (this.fstrRowSource == null ? that.fstrRowSource == null : this.fstrRowSource.equals(that.fstrRowSource));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrRowSource = JdbcWritableBridge.readString(6, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrRowSource, 6 + __off, -9, __dbStmt);
    return 6;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrRowSource = null;
    } else {
    this.fstrRowSource = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrRowSource) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrRowSource);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrRowSource==null?"\\N":fstrRowSource, " ", delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrRowSource = null; } else {
      this.fstrRowSource = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    vlnweblogonactivitysource o = (vlnweblogonactivitysource) super.clone();
    return o;
  }

  public void clone0(vlnweblogonactivitysource o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fstrRowSource", this.fstrRowSource);
