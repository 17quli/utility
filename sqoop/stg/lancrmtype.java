// ORM class for table 'lancrmtype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:09:18 NZDT 2020
...
public class lancrmtype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lancrmtype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrCrmType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmtype.this.fstrCrmType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmtype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmtype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmtype.this.fstrDescription = (String)value;
      }
    });
  }
  public lancrmtype() {
  ...
  public lancrmtype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrCrmType;
  public String get_fstrCrmType() {
    return fstrCrmType;
  }
  public void set_fstrCrmType(String fstrCrmType) {
    this.fstrCrmType = fstrCrmType;
  }
  public lancrmtype with_fstrCrmType(String fstrCrmType) {
    this.fstrCrmType = fstrCrmType;
    return this;
  }
  ...
  public lancrmtype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lancrmtype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lancrmtype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lancrmtype)) {
      return false;
    }
    lancrmtype that = (lancrmtype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrCrmType == null ? that.fstrCrmType == null : this.fstrCrmType.equals(that.fstrCrmType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrCrmType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrCrmType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrCrmType = null;
    } else {
    this.fstrCrmType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrCrmType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrCrmType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrCrmType==null?"\\N":fstrCrmType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrCrmType = null; } else {
      this.fstrCrmType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lancrmtype o = (lancrmtype) super.clone();
    return o;
  }

  public void clone0(lancrmtype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrCrmType", this.fstrCrmType);
