// ORM class for table 'lanwebreqtype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:07:55 NZDT 2020
...
public class lanwebreqtype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanwebreqtype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrWebReqType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqtype.this.fstrWebReqType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqtype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqtype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDecodeWeb", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqtype.this.fstrDecodeWeb = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebreqtype.this.fstrDescription = (String)value;
      }
    });
  }
  public lanwebreqtype() {
    init0();
  }
  ...
  public lanwebreqtype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrWebReqType;
  public String get_fstrWebReqType() {
    return fstrWebReqType;
  }
  public void set_fstrWebReqType(String fstrWebReqType) {
    this.fstrWebReqType = fstrWebReqType;
  }
  public lanwebreqtype with_fstrWebReqType(String fstrWebReqType) {
    this.fstrWebReqType = fstrWebReqType;
    return this;
  }
  ...
  public lanwebreqtype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanwebreqtype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanwebreqtype with_fstrDecodeWeb(String fstrDecodeWeb) {
    this.fstrDecodeWeb = fstrDecodeWeb;
    return this;
  }
  ...
  public lanwebreqtype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanwebreqtype)) {
      return false;
    }
    lanwebreqtype that = (lanwebreqtype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrWebReqType == null ? that.fstrWebReqType == null : this.fstrWebReqType.equals(that.fstrWebReqType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrWebReqType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrWebReqType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrWebReqType = null;
    } else {
    this.fstrWebReqType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrWebReqType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrWebReqType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrWebReqType==null?"\\N":fstrWebReqType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrWebReqType = null; } else {
      this.fstrWebReqType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanwebreqtype o = (lanwebreqtype) super.clone();
    return o;
  }

  public void clone0(lanwebreqtype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrWebReqType", this.fstrWebReqType);
