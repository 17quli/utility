// ORM class for table 'tblprofile'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:20:47 NZDT 2020
...
public class tblprofile extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblprofile.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("fintProfileNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fintProfileNumber = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("fstrProfileType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fstrProfileType = (String)value;
      }
    });
    setters.put("fblnDefault", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fblnDefault = (Integer)value;
      }
    });
    setters.put("fintParentProfileNumber", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fintParentProfileNumber = (Integer)value;
      }
    });
    setters.put("flngDocKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("fdtmCommence", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fdtmCommence = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCease", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fdtmCease = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCreated", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fdtmCreated = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblprofile.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblprofile() {
  ...
  public tblprofile with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblprofile with_fintProfileNumber(Integer fintProfileNumber) {
    this.fintProfileNumber = fintProfileNumber;
    return this;
  }
  ...
  public tblprofile with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblprofile with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblprofile with_fstrProfileType(String fstrProfileType) {
    this.fstrProfileType = fstrProfileType;
    return this;
  }
  ...
  public tblprofile with_fblnDefault(Integer fblnDefault) {
    this.fblnDefault = fblnDefault;
    return this;
  }
  ...
  public tblprofile with_fintParentProfileNumber(Integer fintParentProfileNumber) {
    this.fintParentProfileNumber = fintParentProfileNumber;
    return this;
  }
  ...
  public tblprofile with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblprofile with_fdtmCommence(java.sql.Timestamp fdtmCommence) {
    this.fdtmCommence = fdtmCommence;
    return this;
  }
  ...
  public tblprofile with_fdtmCease(java.sql.Timestamp fdtmCease) {
    this.fdtmCease = fdtmCease;
    return this;
  }
  ...
  public tblprofile with_fdtmCreated(java.sql.Timestamp fdtmCreated) {
    this.fdtmCreated = fdtmCreated;
    return this;
  }
  ...
  public tblprofile with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblprofile with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblprofile)) {
      return false;
    }
    tblprofile that = (tblprofile) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrProfileType = JdbcWritableBridge.readString(5, __dbResults);
    this.fblnDefault = JdbcWritableBridge.readInteger(6, __dbResults);
    this.fintParentProfileNumber = JdbcWritableBridge.readInteger(7, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrProfileType, 5 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnDefault, 6 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeInteger(fintParentProfileNumber, 7 + __off, 5, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblprofile o = (tblprofile) super.clone();
  ...
  public void clone0(tblprofile o) throws CloneNotSupportedException {
    o.fdtmCommence = (o.fdtmCommence != null) ? (java.sql.Timestamp) o.fdtmCommence.clone() : null;
    o.fdtmCease = (o.fdtmCease != null) ? (java.sql.Timestamp) o.fdtmCease.clone() : null;
    o.fdtmCreated = (o.fdtmCreated != null) ? (java.sql.Timestamp) o.fdtmCreated.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
