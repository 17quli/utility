// ORM class for table 'lanregregistrationtype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:38:26 NZDT 2020
...
public class lanregregistrationtype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanregregistrationtype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrRegistrationType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanregregistrationtype.this.fstrRegistrationType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanregregistrationtype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanregregistrationtype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanregregistrationtype.this.fstrDescription = (String)value;
      }
    });
  }
  public lanregregistrationtype() {
    init0();
  }
  ...
  public lanregregistrationtype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrRegistrationType;
  public String get_fstrRegistrationType() {
    return fstrRegistrationType;
  }
  public void set_fstrRegistrationType(String fstrRegistrationType) {
    this.fstrRegistrationType = fstrRegistrationType;
  }
  public lanregregistrationtype with_fstrRegistrationType(String fstrRegistrationType) {
    this.fstrRegistrationType = fstrRegistrationType;
    return this;
  }
  ...
  public lanregregistrationtype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanregregistrationtype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanregregistrationtype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanregregistrationtype)) {
      return false;
    }
    lanregregistrationtype that = (lanregregistrationtype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrRegistrationType == null ? that.fstrRegistrationType == null : this.fstrRegistrationType.equals(that.fstrRegistrationType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrRegistrationType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrRegistrationType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrRegistrationType = null;
    } else {
    this.fstrRegistrationType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrRegistrationType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrRegistrationType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrRegistrationType==null?"\\N":fstrRegistrationType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrRegistrationType = null; } else {
      this.fstrRegistrationType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanregregistrationtype o = (lanregregistrationtype) super.clone();
    return o;
  }

  public void clone0(lanregregistrationtype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrRegistrationType", this.fstrRegistrationType);
