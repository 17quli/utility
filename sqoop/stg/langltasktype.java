// ORM class for table 'langltasktype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:05:59 NZDT 2020
...
public class langltasktype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        langltasktype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrGLTaskType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltasktype.this.fstrGLTaskType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltasktype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltasktype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltasktype.this.fstrDescription = (String)value;
      }
    });
  }
  public langltasktype() {
    init0();
  }
  ...
  public langltasktype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrGLTaskType;
  public String get_fstrGLTaskType() {
    return fstrGLTaskType;
  }
  public void set_fstrGLTaskType(String fstrGLTaskType) {
    this.fstrGLTaskType = fstrGLTaskType;
  }
  public langltasktype with_fstrGLTaskType(String fstrGLTaskType) {
    this.fstrGLTaskType = fstrGLTaskType;
    return this;
  }
  ...
  public langltasktype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public langltasktype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public langltasktype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof langltasktype)) {
      return false;
    }
    langltasktype that = (langltasktype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrGLTaskType == null ? that.fstrGLTaskType == null : this.fstrGLTaskType.equals(that.fstrGLTaskType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrGLTaskType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrGLTaskType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrGLTaskType = null;
    } else {
    this.fstrGLTaskType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrGLTaskType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrGLTaskType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrGLTaskType==null?"\\N":fstrGLTaskType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrGLTaskType = null; } else {
      this.fstrGLTaskType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    langltasktype o = (langltasktype) super.clone();
    return o;
  }

  public void clone0(langltasktype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrGLTaskType", this.fstrGLTaskType);
