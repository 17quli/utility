// ORM class for table 'lanpbstageflow'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:55:04 NZDT 2020
...
public class lanpbstageflow extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanpbstageflow.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrBilltype", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fstrBilltype = (String)value;
      }
    });
    setters.put("fstrStageFrom", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fstrStageFrom = (String)value;
      }
    });
    setters.put("fstrStageTo", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fstrStageTo = (String)value;
      }
    });
    setters.put("fintSequence", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fintSequence = (Integer)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanpbstageflow.this.fstrDescription = (String)value;
      }
    });
  }
  public lanpbstageflow() {
    init0();
  }
  ...
  public lanpbstageflow with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lanpbstageflow with_fstrBilltype(String fstrBilltype) {
    this.fstrBilltype = fstrBilltype;
    return this;
  }
  private String fstrStageFrom;
  public String get_fstrStageFrom() {
    return fstrStageFrom;
  }
  public void set_fstrStageFrom(String fstrStageFrom) {
    this.fstrStageFrom = fstrStageFrom;
  }
  public lanpbstageflow with_fstrStageFrom(String fstrStageFrom) {
    this.fstrStageFrom = fstrStageFrom;
    return this;
  }
  private String fstrStageTo;
  public String get_fstrStageTo() {
    return fstrStageTo;
  }
  public void set_fstrStageTo(String fstrStageTo) {
    this.fstrStageTo = fstrStageTo;
  }
  public lanpbstageflow with_fstrStageTo(String fstrStageTo) {
    this.fstrStageTo = fstrStageTo;
    return this;
  }
  ...
  public lanpbstageflow with_fintSequence(Integer fintSequence) {
    this.fintSequence = fintSequence;
    return this;
  }
  ...
  public lanpbstageflow with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanpbstageflow with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanpbstageflow with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanpbstageflow)) {
      return false;
    }
    lanpbstageflow that = (lanpbstageflow) o;
    boolean equal = true;
    ...
    equal = equal && (this.fstrStageFrom == null ? that.fstrStageFrom == null : this.fstrStageFrom.equals(that.fstrStageFrom));
    equal = equal && (this.fstrStageTo == null ? that.fstrStageTo == null : this.fstrStageTo.equals(that.fstrStageTo));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrBilltype = JdbcWritableBridge.readString(2, __dbResults);
    this.fstrStageFrom = JdbcWritableBridge.readString(3, __dbResults);
    this.fstrStageTo = JdbcWritableBridge.readString(4, __dbResults);
    this.fintSequence = JdbcWritableBridge.readInteger(5, __dbResults);
    this.fstrDecode1 = JdbcWritableBridge.readString(6, __dbResults);
    this.fstrDecode2 = JdbcWritableBridge.readString(7, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrBilltype, 2 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrStageFrom, 3 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrStageTo, 4 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(fintSequence, 5 + __off, 5, __dbStmt);
    JdbcWritableBridge.writeString(fstrDecode1, 6 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrDecode2, 7 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrStageFrom = null;
    } else {
    this.fstrStageFrom = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
        this.fstrStageTo = null;
    } else {
    this.fstrStageTo = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrStageFrom) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrStageFrom);
    }
    if (null == this.fstrStageTo) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrStageTo);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrStageFrom==null?"\\N":fstrStageFrom, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrStageTo==null?"\\N":fstrStageTo, " ", delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrStageFrom = null; } else {
      this.fstrStageFrom = __cur_str;
    }
    ...
    if (__cur_str.equals("null")) { this.fstrStageTo = null; } else {
      this.fstrStageTo = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanpbstageflow o = (lanpbstageflow) super.clone();
    return o;
  }

  public void clone0(lanpbstageflow o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fstrStageFrom", this.fstrStageFrom);
    __sqoop$field_map.put("fstrStageTo", this.fstrStageTo);
