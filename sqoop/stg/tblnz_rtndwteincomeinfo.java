// ORM class for table 'tblnz_rtndwteincomeinfo'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 05:11:46 NZDT 2020
...
public class tblnz_rtndwteincomeinfo extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fi64SubLineItemKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fi64SubLineItemKey = (Long)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("fi64LineItemKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fi64LineItemKey = (Long)value;
      }
    });
    setters.put("fstrIncomeType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fstrIncomeType = (String)value;
      }
    });
    setters.put("fcurGrossAmount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fcurGrossAmount = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurDeducted", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fcurDeducted = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurRWTRate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fcurRWTRate = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurImputationCredits", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fcurImputationCredits = (java.math.BigDecimal)value;
      }
    });
    setters.put("fcurCreditRatio", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fcurCreditRatio = (java.math.BigDecimal)value;
      }
    });
    setters.put("fblnAUDividendPaid", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fblnAUDividendPaid = (Integer)value;
      }
    });
    setters.put("fcurAUExchangeRate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fcurAUExchangeRate = (java.math.BigDecimal)value;
      }
    });
    setters.put("fblnInError", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fblnInError = (Integer)value;
      }
    });
    setters.put("fdtmDeleted", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fdtmDeleted = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtndwteincomeinfo.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_rtndwteincomeinfo() {
    init0();
  }
  ...
  public tblnz_rtndwteincomeinfo with_fi64SubLineItemKey(Long fi64SubLineItemKey) {
    this.fi64SubLineItemKey = fi64SubLineItemKey;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fi64LineItemKey(Long fi64LineItemKey) {
    this.fi64LineItemKey = fi64LineItemKey;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fstrIncomeType(String fstrIncomeType) {
    this.fstrIncomeType = fstrIncomeType;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fcurGrossAmount(java.math.BigDecimal fcurGrossAmount) {
    this.fcurGrossAmount = fcurGrossAmount;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fcurDeducted(java.math.BigDecimal fcurDeducted) {
    this.fcurDeducted = fcurDeducted;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fcurRWTRate(java.math.BigDecimal fcurRWTRate) {
    this.fcurRWTRate = fcurRWTRate;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fcurImputationCredits(java.math.BigDecimal fcurImputationCredits) {
    this.fcurImputationCredits = fcurImputationCredits;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fcurCreditRatio(java.math.BigDecimal fcurCreditRatio) {
    this.fcurCreditRatio = fcurCreditRatio;
    return this;
  }
  private Integer fblnAUDividendPaid;
  public Integer get_fblnAUDividendPaid() {
    return fblnAUDividendPaid;
  }
  public void set_fblnAUDividendPaid(Integer fblnAUDividendPaid) {
    this.fblnAUDividendPaid = fblnAUDividendPaid;
  }
  public tblnz_rtndwteincomeinfo with_fblnAUDividendPaid(Integer fblnAUDividendPaid) {
    this.fblnAUDividendPaid = fblnAUDividendPaid;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fcurAUExchangeRate(java.math.BigDecimal fcurAUExchangeRate) {
    this.fcurAUExchangeRate = fcurAUExchangeRate;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fblnInError(Integer fblnInError) {
    this.fblnInError = fblnInError;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fdtmDeleted(java.sql.Timestamp fdtmDeleted) {
    this.fdtmDeleted = fdtmDeleted;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_rtndwteincomeinfo with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_rtndwteincomeinfo)) {
      return false;
    }
    tblnz_rtndwteincomeinfo that = (tblnz_rtndwteincomeinfo) o;
    boolean equal = true;
    ...
    equal = equal && (this.fblnAUDividendPaid == null ? that.fblnAUDividendPaid == null : this.fblnAUDividendPaid.equals(that.fblnAUDividendPaid));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fcurDeducted = JdbcWritableBridge.readBigDecimal(7, __dbResults);
    this.fcurRWTRate = JdbcWritableBridge.readBigDecimal(8, __dbResults);
    this.fcurImputationCredits = JdbcWritableBridge.readBigDecimal(9, __dbResults);
    this.fcurCreditRatio = JdbcWritableBridge.readBigDecimal(10, __dbResults);
    this.fblnAUDividendPaid = JdbcWritableBridge.readInteger(11, __dbResults);
    this.fcurAUExchangeRate = JdbcWritableBridge.readBigDecimal(12, __dbResults);
    this.fblnInError = JdbcWritableBridge.readInteger(13, __dbResults);
    this.fdtmDeleted = JdbcWritableBridge.readTimestamp(14, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeBigDecimal(fcurDeducted, 7 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurRWTRate, 8 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurImputationCredits, 9 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurCreditRatio, 10 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnAUDividendPaid, 11 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeBigDecimal(fcurAUExchangeRate, 12 + __off, 3, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnInError, 13 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmDeleted, 14 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fblnAUDividendPaid = null;
    } else {
    this.fblnAUDividendPaid = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fblnAUDividendPaid) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.fblnAUDividendPaid);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fblnAUDividendPaid==null?"\\N":"" + fblnAUDividendPaid, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fblnAUDividendPaid = null; } else {
      this.fblnAUDividendPaid = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_rtndwteincomeinfo o = (tblnz_rtndwteincomeinfo) super.clone();
    o.fdtmDeleted = (o.fdtmDeleted != null) ? (java.sql.Timestamp) o.fdtmDeleted.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
    return o;
  }

  public void clone0(tblnz_rtndwteincomeinfo o) throws CloneNotSupportedException {
    o.fdtmDeleted = (o.fdtmDeleted != null) ? (java.sql.Timestamp) o.fdtmDeleted.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fblnAUDividendPaid", this.fblnAUDividendPaid);
