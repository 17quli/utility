// ORM class for table 'lannz_audcustomergroup'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 01:24:18 NZDT 2020
...
public class lannz_audcustomergroup extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_audcustomergroup.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrCustomerGroup", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcustomergroup.this.fstrCustomerGroup = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcustomergroup.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcustomergroup.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcustomergroup.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_audcustomergroup() {
    init0();
  }
  ...
  public lannz_audcustomergroup with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrCustomerGroup;
  public String get_fstrCustomerGroup() {
    return fstrCustomerGroup;
  }
  public void set_fstrCustomerGroup(String fstrCustomerGroup) {
    this.fstrCustomerGroup = fstrCustomerGroup;
  }
  public lannz_audcustomergroup with_fstrCustomerGroup(String fstrCustomerGroup) {
    this.fstrCustomerGroup = fstrCustomerGroup;
    return this;
  }
  ...
  public lannz_audcustomergroup with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_audcustomergroup with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_audcustomergroup with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_audcustomergroup)) {
      return false;
    }
    lannz_audcustomergroup that = (lannz_audcustomergroup) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrCustomerGroup == null ? that.fstrCustomerGroup == null : this.fstrCustomerGroup.equals(that.fstrCustomerGroup));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrCustomerGroup = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrCustomerGroup, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrCustomerGroup = null;
    } else {
    this.fstrCustomerGroup = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrCustomerGroup) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrCustomerGroup);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrCustomerGroup==null?"\\N":fstrCustomerGroup, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrCustomerGroup = null; } else {
      this.fstrCustomerGroup = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_audcustomergroup o = (lannz_audcustomergroup) super.clone();
    return o;
  }

  public void clone0(lannz_audcustomergroup o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrCustomerGroup", this.fstrCustomerGroup);
