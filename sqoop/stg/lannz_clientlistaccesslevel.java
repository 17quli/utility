// ORM class for table 'lannz_clientlistaccesslevel'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:35:36 NZDT 2020
...
public class lannz_clientlistaccesslevel extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_clientlistaccesslevel.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrAccessLevel", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_clientlistaccesslevel.this.fstrAccessLevel = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_clientlistaccesslevel.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_clientlistaccesslevel.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_clientlistaccesslevel.this.fstrDescription = (String)value;
      }
    });
    setters.put("fstrDescriptionWeb", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_clientlistaccesslevel.this.fstrDescriptionWeb = (String)value;
      }
    });
  }
  public lannz_clientlistaccesslevel() {
    init0();
  }
  ...
  public lannz_clientlistaccesslevel with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrAccessLevel;
  public String get_fstrAccessLevel() {
    return fstrAccessLevel;
  }
  public void set_fstrAccessLevel(String fstrAccessLevel) {
    this.fstrAccessLevel = fstrAccessLevel;
  }
  public lannz_clientlistaccesslevel with_fstrAccessLevel(String fstrAccessLevel) {
    this.fstrAccessLevel = fstrAccessLevel;
    return this;
  }
  ...
  public lannz_clientlistaccesslevel with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_clientlistaccesslevel with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_clientlistaccesslevel with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  ...
  public lannz_clientlistaccesslevel with_fstrDescriptionWeb(String fstrDescriptionWeb) {
    this.fstrDescriptionWeb = fstrDescriptionWeb;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_clientlistaccesslevel)) {
      return false;
    }
    lannz_clientlistaccesslevel that = (lannz_clientlistaccesslevel) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrAccessLevel == null ? that.fstrAccessLevel == null : this.fstrAccessLevel.equals(that.fstrAccessLevel));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrAccessLevel = JdbcWritableBridge.readString(2, __dbResults);
    ...
    this.fstrDescriptionWeb = JdbcWritableBridge.readString(6, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrAccessLevel, 2 + __off, -9, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrDescriptionWeb, 6 + __off, -9, __dbStmt);
    return 6;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrAccessLevel = null;
    } else {
    this.fstrAccessLevel = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrAccessLevel) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrAccessLevel);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrAccessLevel==null?"\\N":fstrAccessLevel, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrAccessLevel = null; } else {
      this.fstrAccessLevel = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_clientlistaccesslevel o = (lannz_clientlistaccesslevel) super.clone();
    return o;
  }

  public void clone0(lannz_clientlistaccesslevel o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrAccessLevel", this.fstrAccessLevel);
