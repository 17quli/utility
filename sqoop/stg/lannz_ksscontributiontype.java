// ORM class for table 'lannz_ksscontributiontype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:30:06 NZDT 2020
...
public class lannz_ksscontributiontype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrContributionType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fstrContributionType = (String)value;
      }
    });
    setters.put("fdtmEffectiveFrom", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fdtmEffectiveFrom = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrWebDecode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fstrWebDecode = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontributiontype.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_ksscontributiontype() {
    init0();
  }
  ...
  public lannz_ksscontributiontype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lannz_ksscontributiontype with_fstrContributionType(String fstrContributionType) {
    this.fstrContributionType = fstrContributionType;
    return this;
  }
  private java.sql.Timestamp fdtmEffectiveFrom;
  public java.sql.Timestamp get_fdtmEffectiveFrom() {
    return fdtmEffectiveFrom;
  }
  public void set_fdtmEffectiveFrom(java.sql.Timestamp fdtmEffectiveFrom) {
    this.fdtmEffectiveFrom = fdtmEffectiveFrom;
  }
  public lannz_ksscontributiontype with_fdtmEffectiveFrom(java.sql.Timestamp fdtmEffectiveFrom) {
    this.fdtmEffectiveFrom = fdtmEffectiveFrom;
    return this;
  }
  ...
  public lannz_ksscontributiontype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_ksscontributiontype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  private String fstrWebDecode;
  public String get_fstrWebDecode() {
    return fstrWebDecode;
  }
  public void set_fstrWebDecode(String fstrWebDecode) {
    this.fstrWebDecode = fstrWebDecode;
  }
  public lannz_ksscontributiontype with_fstrWebDecode(String fstrWebDecode) {
    this.fstrWebDecode = fstrWebDecode;
    return this;
  }
  ...
  public lannz_ksscontributiontype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_ksscontributiontype)) {
      return false;
    }
    lannz_ksscontributiontype that = (lannz_ksscontributiontype) o;
    boolean equal = true;
    ...
    equal = equal && (this.fdtmEffectiveFrom == null ? that.fdtmEffectiveFrom == null : this.fdtmEffectiveFrom.equals(that.fdtmEffectiveFrom));
    ...
    equal = equal && (this.fstrWebDecode == null ? that.fstrWebDecode == null : this.fstrWebDecode.equals(that.fstrWebDecode));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrContributionType = JdbcWritableBridge.readString(2, __dbResults);
    this.fdtmEffectiveFrom = JdbcWritableBridge.readTimestamp(3, __dbResults);
    this.fstrDecode1 = JdbcWritableBridge.readString(4, __dbResults);
    this.fstrDecode2 = JdbcWritableBridge.readString(5, __dbResults);
    this.fstrWebDecode = JdbcWritableBridge.readString(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrContributionType, 2 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmEffectiveFrom, 3 + __off, 93, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrWebDecode, 6 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fdtmEffectiveFrom = null;
    } else {
    this.fdtmEffectiveFrom = new Timestamp(__dataIn.readLong());
    this.fdtmEffectiveFrom.setNanos(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrWebDecode = null;
    } else {
    this.fstrWebDecode = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fdtmEffectiveFrom) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeLong(this.fdtmEffectiveFrom.getTime());
    __dataOut.writeInt(this.fdtmEffectiveFrom.getNanos());
    }
    ...
    if (null == this.fstrWebDecode) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrWebDecode);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fdtmEffectiveFrom==null?"\\N":"" + fdtmEffectiveFrom, delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrWebDecode==null?"\\N":fstrWebDecode, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fdtmEffectiveFrom = null; } else {
      this.fdtmEffectiveFrom = java.sql.Timestamp.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null")) { this.fstrWebDecode = null; } else {
      this.fstrWebDecode = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_ksscontributiontype o = (lannz_ksscontributiontype) super.clone();
    o.fdtmEffectiveFrom = (o.fdtmEffectiveFrom != null) ? (java.sql.Timestamp) o.fdtmEffectiveFrom.clone() : null;
    return o;
  }

  public void clone0(lannz_ksscontributiontype o) throws CloneNotSupportedException {
    o.fdtmEffectiveFrom = (o.fdtmEffectiveFrom != null) ? (java.sql.Timestamp) o.fdtmEffectiveFrom.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fdtmEffectiveFrom", this.fdtmEffectiveFrom);
    __sqoop$field_map.put("fstrDecode1", this.fstrDecode1);
    __sqoop$field_map.put("fstrDecode2", this.fstrDecode2);
    __sqoop$field_map.put("fstrWebDecode", this.fstrWebDecode);
