// ORM class for table 'tblnz_keyofficeholders'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 05:58:18 NZDT 2020
...
public class tblnz_keyofficeholders extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngDocKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_keyofficeholders.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("flngIndicatorKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.flngIndicatorKey = (Integer)value;
      }
    });
    setters.put("fintSeq", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fintSeq = (Integer)value;
      }
    });
    setters.put("fstrIRD", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fstrIRD = (String)value;
      }
    });
    setters.put("fstrName", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fstrName = (String)value;
      }
    });
    setters.put("fstrPositionHeld", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fstrPositionHeld = (String)value;
      }
    });
    setters.put("fdtmBegin", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fdtmBegin = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmEnd", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fdtmEnd = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrEndReason", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fstrEndReason = (String)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_keyofficeholders.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_keyofficeholders() {
    init0();
  }
  ...
  public tblnz_keyofficeholders with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_flngIndicatorKey(Integer flngIndicatorKey) {
    this.flngIndicatorKey = flngIndicatorKey;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fintSeq(Integer fintSeq) {
    this.fintSeq = fintSeq;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fstrIRD(String fstrIRD) {
    this.fstrIRD = fstrIRD;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fstrName(String fstrName) {
    this.fstrName = fstrName;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fstrPositionHeld(String fstrPositionHeld) {
    this.fstrPositionHeld = fstrPositionHeld;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fdtmBegin(java.sql.Timestamp fdtmBegin) {
    this.fdtmBegin = fdtmBegin;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fdtmEnd(java.sql.Timestamp fdtmEnd) {
    this.fdtmEnd = fdtmEnd;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fstrEndReason(String fstrEndReason) {
    this.fstrEndReason = fstrEndReason;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_keyofficeholders with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_keyofficeholders)) {
      return false;
    }
    tblnz_keyofficeholders that = (tblnz_keyofficeholders) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngIndicatorKey = JdbcWritableBridge.readInteger(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(flngIndicatorKey, 2 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_keyofficeholders o = (tblnz_keyofficeholders) super.clone();
  ...
  public void clone0(tblnz_keyofficeholders o) throws CloneNotSupportedException {
    o.fdtmBegin = (o.fdtmBegin != null) ? (java.sql.Timestamp) o.fdtmBegin.clone() : null;
    o.fdtmEnd = (o.fdtmEnd != null) ? (java.sql.Timestamp) o.fdtmEnd.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
