// ORM class for table 'tblnz_provmethod'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 01:49:11 NZDT 2020
...
public class tblnz_provmethod extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  public static interface FieldSetterCommand {    void setField(Object value);  }  protected ResultSet __cur_result_set;
  private Map<String, FieldSetterCommand> setters = new HashMap<String, FieldSetterCommand>();
  private void init0() {
    setters.put("flngMethodKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.flngMethodKey = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("flngCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.flngCustomerKey = (Integer)value;
      }
    });
    setters.put("flngAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.flngAccountKey = (Integer)value;
      }
    });
    setters.put("fstrMethod", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fstrMethod = (String)value;
      }
    });
    setters.put("fintTaxYear", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fintTaxYear = (Integer)value;
      }
    });
    setters.put("fdtmCommence", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fdtmCommence = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCease", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fdtmCease = (java.sql.Timestamp)value;
      }
    });
    setters.put("fcurAmount", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fcurAmount = (java.math.BigDecimal)value;
      }
    });
    setters.put("fdblRatio", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fdblRatio = (Double)value;
      }
    });
    setters.put("fstrSource", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fstrSource = (String)value;
      }
    });
    setters.put("flngSourceKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.flngSourceKey = (Integer)value;
      }
    });
    setters.put("fblnActive", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fblnActive = (Integer)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_provmethod.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_provmethod() {
    init0();
  }
  private Integer flngMethodKey;
  public Integer get_flngMethodKey() {
    return flngMethodKey;
  }
  public void set_flngMethodKey(Integer flngMethodKey) {
    this.flngMethodKey = flngMethodKey;
  }
  public tblnz_provmethod with_flngMethodKey(Integer flngMethodKey) {
    this.flngMethodKey = flngMethodKey;
    return this;
  }
  ...
  public tblnz_provmethod with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblnz_provmethod with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblnz_provmethod with_flngCustomerKey(Integer flngCustomerKey) {
    this.flngCustomerKey = flngCustomerKey;
    return this;
  }
  ...
  public tblnz_provmethod with_flngAccountKey(Integer flngAccountKey) {
    this.flngAccountKey = flngAccountKey;
    return this;
  }
  ...
  public tblnz_provmethod with_fstrMethod(String fstrMethod) {
    this.fstrMethod = fstrMethod;
    return this;
  }
  ...
  public tblnz_provmethod with_fintTaxYear(Integer fintTaxYear) {
    this.fintTaxYear = fintTaxYear;
    return this;
  }
  ...
  public tblnz_provmethod with_fdtmCommence(java.sql.Timestamp fdtmCommence) {
    this.fdtmCommence = fdtmCommence;
    return this;
  }
  ...
  public tblnz_provmethod with_fdtmCease(java.sql.Timestamp fdtmCease) {
    this.fdtmCease = fdtmCease;
    return this;
  }
  ...
  public tblnz_provmethod with_fcurAmount(java.math.BigDecimal fcurAmount) {
    this.fcurAmount = fcurAmount;
    return this;
  }
  private Double fdblRatio;
  public Double get_fdblRatio() {
    return fdblRatio;
  }
  public void set_fdblRatio(Double fdblRatio) {
    this.fdblRatio = fdblRatio;
  }
  public tblnz_provmethod with_fdblRatio(Double fdblRatio) {
    this.fdblRatio = fdblRatio;
    return this;
  }
  ...
  public tblnz_provmethod with_fstrSource(String fstrSource) {
    this.fstrSource = fstrSource;
    return this;
  }
  private Integer flngSourceKey;
  public Integer get_flngSourceKey() {
    return flngSourceKey;
  }
  public void set_flngSourceKey(Integer flngSourceKey) {
    this.flngSourceKey = flngSourceKey;
  }
  public tblnz_provmethod with_flngSourceKey(Integer flngSourceKey) {
    this.flngSourceKey = flngSourceKey;
    return this;
  }
  ...
  public tblnz_provmethod with_fblnActive(Integer fblnActive) {
    this.fblnActive = fblnActive;
    return this;
  }
  ...
  public tblnz_provmethod with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_provmethod with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_provmethod)) {
      return false;
    }
    tblnz_provmethod that = (tblnz_provmethod) o;
    boolean equal = true;
    equal = equal && (this.flngMethodKey == null ? that.flngMethodKey == null : this.flngMethodKey.equals(that.flngMethodKey));
    ...
    equal = equal && (this.fdblRatio == null ? that.fdblRatio == null : this.fdblRatio.equals(that.fdblRatio));
    equal = equal && (this.fstrSource == null ? that.fstrSource == null : this.fstrSource.equals(that.fstrSource));
    equal = equal && (this.flngSourceKey == null ? that.flngSourceKey == null : this.flngSourceKey.equals(that.flngSourceKey));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngMethodKey = JdbcWritableBridge.readInteger(1, __dbResults);
    ...
    this.fstrMethod = JdbcWritableBridge.readString(6, __dbResults);
    this.fintTaxYear = JdbcWritableBridge.readInteger(7, __dbResults);
    ...
    this.fdblRatio = JdbcWritableBridge.readDouble(11, __dbResults);
    this.fstrSource = JdbcWritableBridge.readString(12, __dbResults);
    this.flngSourceKey = JdbcWritableBridge.readInteger(13, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(flngMethodKey, 1 + __off, 4, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrMethod, 6 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(fintTaxYear, 7 + __off, 5, __dbStmt);
    ...
    JdbcWritableBridge.writeDouble(fdblRatio, 11 + __off, 8, __dbStmt);
    JdbcWritableBridge.writeString(fstrSource, 12 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(flngSourceKey, 13 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    if (__dataIn.readBoolean()) { 
        this.flngMethodKey = null;
    } else {
    this.flngMethodKey = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
        this.flngVer = null;
    } else {
    ...
    this.fdblRatio = Double.valueOf(__dataIn.readDouble());
    }
    if (__dataIn.readBoolean()) { 
    ...
    if (__dataIn.readBoolean()) { 
        this.flngSourceKey = null;
    } else {
    this.flngSourceKey = Integer.valueOf(__dataIn.readInt());
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    if (null == this.flngMethodKey) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.flngMethodKey);
    }
    ...
    if (null == this.fdblRatio) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeDouble(this.fdblRatio);
    }
    ...
    if (null == this.flngSourceKey) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    __dataOut.writeInt(this.flngSourceKey);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.escapeAndEnclose(flngMethodKey==null?"\\N":"" + flngMethodKey, delimiters));
    ...
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(fdblRatio==null?"\\N":"" + fdblRatio, delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrSource==null?"\\N":fstrSource, " ", delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(flngSourceKey==null?"\\N":"" + flngSourceKey, delimiters));
    __sb.append(fieldDelim);
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.flngMethodKey = null; } else {
      this.flngMethodKey = Integer.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.fdblRatio = null; } else {
      this.fdblRatio = Double.valueOf(__cur_str);
    }
    ...
    if (__cur_str.equals("null") || __cur_str.length() == 0) { this.flngSourceKey = null; } else {
      this.flngSourceKey = Integer.valueOf(__cur_str);
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_provmethod o = (tblnz_provmethod) super.clone();
  ...
  public void clone0(tblnz_provmethod o) throws CloneNotSupportedException {
    o.fdtmCommence = (o.fdtmCommence != null) ? (java.sql.Timestamp) o.fdtmCommence.clone() : null;
    o.fdtmCease = (o.fdtmCease != null) ? (java.sql.Timestamp) o.fdtmCease.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("flngMethodKey", this.flngMethodKey);
    ...
    __sqoop$field_map.put("fdblRatio", this.fdblRatio);
    __sqoop$field_map.put("fstrSource", this.fstrSource);
    __sqoop$field_map.put("flngSourceKey", this.flngSourceKey);
