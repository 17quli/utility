// ORM class for table 'lanaccounttype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 22:40:23 NZDT 2020
...
public class lanaccounttype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanaccounttype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrAccountType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrAccountType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDecode3", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrDecode3 = (String)value;
      }
    });
    setters.put("fstrDecode4", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrDecode4 = (String)value;
      }
    });
    setters.put("fstrDecodeWeb", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrDecodeWeb = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanaccounttype.this.fstrDescription = (String)value;
      }
    });
  }
  public lanaccounttype() {
    init0();
  }
  ...
  public lanaccounttype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lanaccounttype with_fstrAccountType(String fstrAccountType) {
    this.fstrAccountType = fstrAccountType;
    return this;
  }
  ...
  public lanaccounttype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanaccounttype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanaccounttype with_fstrDecode3(String fstrDecode3) {
    this.fstrDecode3 = fstrDecode3;
    return this;
  }
  private String fstrDecode4;
  public String get_fstrDecode4() {
    return fstrDecode4;
  }
  public void set_fstrDecode4(String fstrDecode4) {
    this.fstrDecode4 = fstrDecode4;
  }
  public lanaccounttype with_fstrDecode4(String fstrDecode4) {
    this.fstrDecode4 = fstrDecode4;
    return this;
  }
  ...
  public lanaccounttype with_fstrDecodeWeb(String fstrDecodeWeb) {
    this.fstrDecodeWeb = fstrDecodeWeb;
    return this;
  }
  ...
  public lanaccounttype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanaccounttype)) {
      return false;
    }
    lanaccounttype that = (lanaccounttype) o;
    boolean equal = true;
    ...
    equal = equal && (this.fstrDecode4 == null ? that.fstrDecode4 == null : this.fstrDecode4.equals(that.fstrDecode4));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrDecode4 = JdbcWritableBridge.readString(6, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrDecode4, 6 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrDecode4 = null;
    } else {
    this.fstrDecode4 = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrDecode4) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrDecode4);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrDecode4==null?"\\N":fstrDecode4, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrDecode4 = null; } else {
      this.fstrDecode4 = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanaccounttype o = (lanaccounttype) super.clone();
    return o;
  }

  public void clone0(lanaccounttype o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fstrDecode4", this.fstrDecode4);
