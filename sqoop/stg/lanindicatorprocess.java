// ORM class for table 'lanindicatorprocess'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:02:07 NZDT 2020
...
public class lanindicatorprocess extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanindicatorprocess.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrProcess", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorprocess.this.fstrProcess = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorprocess.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorprocess.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanindicatorprocess.this.fstrDescription = (String)value;
      }
    });
  }
  public lanindicatorprocess() {
    init0();
  }
  ...
  public lanindicatorprocess with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrProcess;
  public String get_fstrProcess() {
    return fstrProcess;
  }
  public void set_fstrProcess(String fstrProcess) {
    this.fstrProcess = fstrProcess;
  }
  public lanindicatorprocess with_fstrProcess(String fstrProcess) {
    this.fstrProcess = fstrProcess;
    return this;
  }
  ...
  public lanindicatorprocess with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanindicatorprocess with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanindicatorprocess with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanindicatorprocess)) {
      return false;
    }
    lanindicatorprocess that = (lanindicatorprocess) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrProcess == null ? that.fstrProcess == null : this.fstrProcess.equals(that.fstrProcess));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrProcess = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrProcess, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrProcess = null;
    } else {
    this.fstrProcess = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrProcess) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrProcess);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrProcess==null?"\\N":fstrProcess, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrProcess = null; } else {
      this.fstrProcess = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanindicatorprocess o = (lanindicatorprocess) super.clone();
    return o;
  }

  public void clone0(lanindicatorprocess o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrProcess", this.fstrProcess);
