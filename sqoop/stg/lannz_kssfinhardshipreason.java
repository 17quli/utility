// ORM class for table 'lannz_kssfinhardshipreason'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:11:55 NZDT 2020
...
public class lannz_kssfinhardshipreason extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrReason", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrReason = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrDescription = (String)value;
      }
    });
    setters.put("fstrWebDecode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrWebDecode = (String)value;
      }
    });
    setters.put("fstrWebDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_kssfinhardshipreason.this.fstrWebDescription = (String)value;
      }
    });
  }
  public lannz_kssfinhardshipreason() {
    init0();
  }
  ...
  public lannz_kssfinhardshipreason with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lannz_kssfinhardshipreason with_fstrReason(String fstrReason) {
    this.fstrReason = fstrReason;
    return this;
  }
  ...
  public lannz_kssfinhardshipreason with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_kssfinhardshipreason with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_kssfinhardshipreason with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  ...
  public lannz_kssfinhardshipreason with_fstrWebDecode(String fstrWebDecode) {
    this.fstrWebDecode = fstrWebDecode;
    return this;
  }
  private String fstrWebDescription;
  public String get_fstrWebDescription() {
    return fstrWebDescription;
  }
  public void set_fstrWebDescription(String fstrWebDescription) {
    this.fstrWebDescription = fstrWebDescription;
  }
  public lannz_kssfinhardshipreason with_fstrWebDescription(String fstrWebDescription) {
    this.fstrWebDescription = fstrWebDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_kssfinhardshipreason)) {
      return false;
    }
    lannz_kssfinhardshipreason that = (lannz_kssfinhardshipreason) o;
    boolean equal = true;
    ...
    equal = equal && (this.fstrWebDescription == null ? that.fstrWebDescription == null : this.fstrWebDescription.equals(that.fstrWebDescription));
    return equal;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrWebDescription = JdbcWritableBridge.readString(7, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrWebDescription, 7 + __off, -9, __dbStmt);
    return 7;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrWebDescription = null;
    } else {
    this.fstrWebDescription = Text.readString(__dataIn);
    }
  }
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrWebDescription) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrWebDescription);
    }
  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrWebDescription==null?"\\N":fstrWebDescription, " ", delimiters));
    if (useRecordDelim) {
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrWebDescription = null; } else {
      this.fstrWebDescription = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_kssfinhardshipreason o = (lannz_kssfinhardshipreason) super.clone();
    return o;
  }

  public void clone0(lannz_kssfinhardshipreason o) throws CloneNotSupportedException {
  }
  ...
  public Map<String, Object> getFieldMap() {
    ...
    __sqoop$field_map.put("fstrWebDescription", this.fstrWebDescription);
