// ORM class for table 'langltaskcategory'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:57:53 NZDT 2020
...
public class langltaskcategory extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        langltaskcategory.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrGLTaskCategory", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltaskcategory.this.fstrGLTaskCategory = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltaskcategory.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltaskcategory.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        langltaskcategory.this.fstrDescription = (String)value;
      }
    });
  }
  public langltaskcategory() {
    init0();
  }
  ...
  public langltaskcategory with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrGLTaskCategory;
  public String get_fstrGLTaskCategory() {
    return fstrGLTaskCategory;
  }
  public void set_fstrGLTaskCategory(String fstrGLTaskCategory) {
    this.fstrGLTaskCategory = fstrGLTaskCategory;
  }
  public langltaskcategory with_fstrGLTaskCategory(String fstrGLTaskCategory) {
    this.fstrGLTaskCategory = fstrGLTaskCategory;
    return this;
  }
  ...
  public langltaskcategory with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public langltaskcategory with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public langltaskcategory with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof langltaskcategory)) {
      return false;
    }
    langltaskcategory that = (langltaskcategory) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrGLTaskCategory == null ? that.fstrGLTaskCategory == null : this.fstrGLTaskCategory.equals(that.fstrGLTaskCategory));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrGLTaskCategory = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrGLTaskCategory, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrGLTaskCategory = null;
    } else {
    this.fstrGLTaskCategory = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrGLTaskCategory) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrGLTaskCategory);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrGLTaskCategory==null?"\\N":fstrGLTaskCategory, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrGLTaskCategory = null; } else {
      this.fstrGLTaskCategory = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    langltaskcategory o = (langltaskcategory) super.clone();
    return o;
  }

  public void clone0(langltaskcategory o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrGLTaskCategory", this.fstrGLTaskCategory);
