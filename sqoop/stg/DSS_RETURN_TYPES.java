...
//
// Debug information:
// Generated date: Fri Dec 04 09:14:50 GMT 2020
...
this.readFields0(__dataIn);  }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.hiveStringReplaceDelims(RETURN_TYPE==null?"\\N":RETURN_TYPE, " ", delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(DATE_APPLIED==null?"\\N":"" + DATE_APPLIED, delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(DESCRIPTION==null?"\\N":DESCRIPTION, " ", delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(DATE_CEASED==null?"\\N":"" + DATE_CEASED, delimiters));
    __sb.append(fieldDelim);
    __sb.append(FieldFormatter.escapeAndEnclose(TIMESTAMP==null?"\\N":"" + TIMESTAMP, delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(VALIDATED==null?"\\N":VALIDATED, " ", delimiters));
    if (useRecordDelim) {
