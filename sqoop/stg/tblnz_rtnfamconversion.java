// ORM class for table 'tblnz_rtnfamconversion'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:54:15 NZDT 2020
...
public class tblnz_rtnfamconversion extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngDocKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_rtnfamconversion.this.flngDocKey = (Integer)value;
      }
    });
    setters.put("fdtmLegacyPNIDate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfamconversion.this.fdtmLegacyPNIDate = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCreditInterestThruDate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfamconversion.this.fdtmCreditInterestThruDate = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmLastStatementDate", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfamconversion.this.fdtmLastStatementDate = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfamconversion.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_rtnfamconversion.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_rtnfamconversion() {
    init0();
  }
  ...
  public tblnz_rtnfamconversion with_flngDocKey(Integer flngDocKey) {
    this.flngDocKey = flngDocKey;
    return this;
  }
  ...
  public tblnz_rtnfamconversion with_fdtmLegacyPNIDate(java.sql.Timestamp fdtmLegacyPNIDate) {
    this.fdtmLegacyPNIDate = fdtmLegacyPNIDate;
    return this;
  }
  ...
  public tblnz_rtnfamconversion with_fdtmCreditInterestThruDate(java.sql.Timestamp fdtmCreditInterestThruDate) {
    this.fdtmCreditInterestThruDate = fdtmCreditInterestThruDate;
    return this;
  }
  ...
  public tblnz_rtnfamconversion with_fdtmLastStatementDate(java.sql.Timestamp fdtmLastStatementDate) {
    this.fdtmLastStatementDate = fdtmLastStatementDate;
    return this;
  }
  ...
  public tblnz_rtnfamconversion with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_rtnfamconversion with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_rtnfamconversion)) {
      return false;
    }
    tblnz_rtnfamconversion that = (tblnz_rtnfamconversion) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fdtmLegacyPNIDate = JdbcWritableBridge.readTimestamp(2, __dbResults);
    this.fdtmCreditInterestThruDate = JdbcWritableBridge.readTimestamp(3, __dbResults);
    this.fdtmLastStatementDate = JdbcWritableBridge.readTimestamp(4, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeTimestamp(fdtmLegacyPNIDate, 2 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmCreditInterestThruDate, 3 + __off, 93, __dbStmt);
    JdbcWritableBridge.writeTimestamp(fdtmLastStatementDate, 4 + __off, 93, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_rtnfamconversion o = (tblnz_rtnfamconversion) super.clone();
  ...
  public void clone0(tblnz_rtnfamconversion o) throws CloneNotSupportedException {
    o.fdtmLegacyPNIDate = (o.fdtmLegacyPNIDate != null) ? (java.sql.Timestamp) o.fdtmLegacyPNIDate.clone() : null;
    o.fdtmCreditInterestThruDate = (o.fdtmCreditInterestThruDate != null) ? (java.sql.Timestamp) o.fdtmCreditInterestThruDate.clone() : null;
    o.fdtmLastStatementDate = (o.fdtmLastStatementDate != null) ? (java.sql.Timestamp) o.fdtmLastStatementDate.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
