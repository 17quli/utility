// ORM class for table 'lancrmsource'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:46:52 NZDT 2020
...
public class lancrmsource extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lancrmsource.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrCrmSource", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmsource.this.fstrCrmSource = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmsource.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmsource.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancrmsource.this.fstrDescription = (String)value;
      }
    });
  }
  public lancrmsource() {
  ...
  public lancrmsource with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrCrmSource;
  public String get_fstrCrmSource() {
    return fstrCrmSource;
  }
  public void set_fstrCrmSource(String fstrCrmSource) {
    this.fstrCrmSource = fstrCrmSource;
  }
  public lancrmsource with_fstrCrmSource(String fstrCrmSource) {
    this.fstrCrmSource = fstrCrmSource;
    return this;
  }
  ...
  public lancrmsource with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lancrmsource with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lancrmsource with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lancrmsource)) {
      return false;
    }
    lancrmsource that = (lancrmsource) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrCrmSource == null ? that.fstrCrmSource == null : this.fstrCrmSource.equals(that.fstrCrmSource));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrCrmSource = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrCrmSource, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrCrmSource = null;
    } else {
    this.fstrCrmSource = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrCrmSource) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrCrmSource);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrCrmSource==null?"\\N":fstrCrmSource, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrCrmSource = null; } else {
      this.fstrCrmSource = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lancrmsource o = (lancrmsource) super.clone();
    return o;
  }

  public void clone0(lancrmsource o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrCrmSource", this.fstrCrmSource);
