// ORM class for table 'lannz_eotstatus'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:37:44 NZDT 2020
...
public class lannz_eotstatus extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_eotstatus.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrEOTStatus", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_eotstatus.this.fstrEOTStatus = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_eotstatus.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_eotstatus.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_eotstatus.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_eotstatus() {
    init0();
  }
  ...
  public lannz_eotstatus with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrEOTStatus;
  public String get_fstrEOTStatus() {
    return fstrEOTStatus;
  }
  public void set_fstrEOTStatus(String fstrEOTStatus) {
    this.fstrEOTStatus = fstrEOTStatus;
  }
  public lannz_eotstatus with_fstrEOTStatus(String fstrEOTStatus) {
    this.fstrEOTStatus = fstrEOTStatus;
    return this;
  }
  ...
  public lannz_eotstatus with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_eotstatus with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_eotstatus with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_eotstatus)) {
      return false;
    }
    lannz_eotstatus that = (lannz_eotstatus) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrEOTStatus == null ? that.fstrEOTStatus == null : this.fstrEOTStatus.equals(that.fstrEOTStatus));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrEOTStatus = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrEOTStatus, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrEOTStatus = null;
    } else {
    this.fstrEOTStatus = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrEOTStatus) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrEOTStatus);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrEOTStatus==null?"\\N":fstrEOTStatus, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrEOTStatus = null; } else {
      this.fstrEOTStatus = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_eotstatus o = (lannz_eotstatus) super.clone();
    return o;
  }

  public void clone0(lannz_eotstatus o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrEOTStatus", this.fstrEOTStatus);
