// ORM class for table 'lannz_corriesort'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:10:38 NZDT 2020
...
public class lannz_corriesort extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_corriesort.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrCorrieSort", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_corriesort.this.fstrCorrieSort = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_corriesort.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_corriesort.this.fstrDecode2 = (String)value;
      }
    });
  }
  public lannz_corriesort() {
    init0();
  }
  ...
  public lannz_corriesort with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrCorrieSort;
  public String get_fstrCorrieSort() {
    return fstrCorrieSort;
  }
  public void set_fstrCorrieSort(String fstrCorrieSort) {
    this.fstrCorrieSort = fstrCorrieSort;
  }
  public lannz_corriesort with_fstrCorrieSort(String fstrCorrieSort) {
    this.fstrCorrieSort = fstrCorrieSort;
    return this;
  }
  ...
  public lannz_corriesort with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_corriesort with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_corriesort)) {
      return false;
    }
    lannz_corriesort that = (lannz_corriesort) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrCorrieSort == null ? that.fstrCorrieSort == null : this.fstrCorrieSort.equals(that.fstrCorrieSort));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrCorrieSort = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrCorrieSort, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrCorrieSort = null;
    } else {
    this.fstrCorrieSort = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrCorrieSort) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrCorrieSort);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrCorrieSort==null?"\\N":fstrCorrieSort, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrCorrieSort = null; } else {
      this.fstrCorrieSort = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_corriesort o = (lannz_corriesort) super.clone();
    return o;
  }

  public void clone0(lannz_corriesort o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrCorrieSort", this.fstrCorrieSort);
