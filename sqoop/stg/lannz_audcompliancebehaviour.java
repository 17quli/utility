// ORM class for table 'lannz_audcompliancebehaviour'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 01:05:32 NZDT 2020
...
public class lannz_audcompliancebehaviour extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lannz_audcompliancebehaviour.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrComplianceBehaviour", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcompliancebehaviour.this.fstrComplianceBehaviour = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcompliancebehaviour.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcompliancebehaviour.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_audcompliancebehaviour.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_audcompliancebehaviour() {
    init0();
  }
  ...
  public lannz_audcompliancebehaviour with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrComplianceBehaviour;
  public String get_fstrComplianceBehaviour() {
    return fstrComplianceBehaviour;
  }
  public void set_fstrComplianceBehaviour(String fstrComplianceBehaviour) {
    this.fstrComplianceBehaviour = fstrComplianceBehaviour;
  }
  public lannz_audcompliancebehaviour with_fstrComplianceBehaviour(String fstrComplianceBehaviour) {
    this.fstrComplianceBehaviour = fstrComplianceBehaviour;
    return this;
  }
  ...
  public lannz_audcompliancebehaviour with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_audcompliancebehaviour with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_audcompliancebehaviour with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_audcompliancebehaviour)) {
      return false;
    }
    lannz_audcompliancebehaviour that = (lannz_audcompliancebehaviour) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrComplianceBehaviour == null ? that.fstrComplianceBehaviour == null : this.fstrComplianceBehaviour.equals(that.fstrComplianceBehaviour));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrComplianceBehaviour = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrComplianceBehaviour, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrComplianceBehaviour = null;
    } else {
    this.fstrComplianceBehaviour = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrComplianceBehaviour) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrComplianceBehaviour);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrComplianceBehaviour==null?"\\N":fstrComplianceBehaviour, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrComplianceBehaviour = null; } else {
      this.fstrComplianceBehaviour = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_audcompliancebehaviour o = (lannz_audcompliancebehaviour) super.clone();
    return o;
  }

  public void clone0(lannz_audcompliancebehaviour o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrComplianceBehaviour", this.fstrComplianceBehaviour);
