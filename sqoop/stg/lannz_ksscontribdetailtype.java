// ORM class for table 'lannz_ksscontribdetailtype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu Dec 03 23:27:23 NZDT 2020
...
public class lannz_ksscontribdetailtype extends SqoopRecord  implements DBWritable, Writable {
  private final int PROTOCOL_VERSION = 3;
  public int getClassFormatVersion() { return PROTOCOL_VERSION; }
  public static interface FieldSetterCommand {    void setField(Object value);  }  protected ResultSet __cur_result_set;
  private Map<String, FieldSetterCommand> setters = new HashMap<String, FieldSetterCommand>();
  private void init0() {
    setters.put("fstrContributionDetailType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontribdetailtype.this.fstrContributionDetailType = (String)value;
      }
    });
    setters.put("fstrLanguage", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontribdetailtype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontribdetailtype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontribdetailtype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lannz_ksscontribdetailtype.this.fstrDescription = (String)value;
      }
    });
  }
  public lannz_ksscontribdetailtype() {
    init0();
  }
  private String fstrContributionDetailType;
  public String get_fstrContributionDetailType() {
    return fstrContributionDetailType;
  }
  public void set_fstrContributionDetailType(String fstrContributionDetailType) {
    this.fstrContributionDetailType = fstrContributionDetailType;
  }
  public lannz_ksscontribdetailtype with_fstrContributionDetailType(String fstrContributionDetailType) {
    this.fstrContributionDetailType = fstrContributionDetailType;
    return this;
  }
  ...
  public lannz_ksscontribdetailtype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  ...
  public lannz_ksscontribdetailtype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lannz_ksscontribdetailtype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lannz_ksscontribdetailtype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lannz_ksscontribdetailtype)) {
      return false;
    }
    lannz_ksscontribdetailtype that = (lannz_ksscontribdetailtype) o;
    boolean equal = true;
    equal = equal && (this.fstrContributionDetailType == null ? that.fstrContributionDetailType == null : this.fstrContributionDetailType.equals(that.fstrContributionDetailType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrContributionDetailType = JdbcWritableBridge.readString(1, __dbResults);
    this.fstrLanguage = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeString(fstrContributionDetailType, 1 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrLanguage, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    if (__dataIn.readBoolean()) { 
        this.fstrContributionDetailType = null;
    } else {
    this.fstrContributionDetailType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    if (null == this.fstrContributionDetailType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrContributionDetailType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrContributionDetailType==null?"\\N":fstrContributionDetailType, " ", delimiters));
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrContributionDetailType = null; } else {
      this.fstrContributionDetailType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lannz_ksscontribdetailtype o = (lannz_ksscontribdetailtype) super.clone();
    return o;
  }

  public void clone0(lannz_ksscontribdetailtype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrContributionDetailType", this.fstrContributionDetailType);
