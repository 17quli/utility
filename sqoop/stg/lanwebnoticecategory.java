// ORM class for table 'lanwebnoticecategory'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 00:13:23 NZDT 2020
...
public class lanwebnoticecategory extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrWebNoticeCategory", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrWebNoticeCategory = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrDescription = (String)value;
      }
    });
    setters.put("fstrDecodeWeb1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrDecodeWeb1 = (String)value;
      }
    });
    setters.put("fstrDecodeWeb2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrDecodeWeb2 = (String)value;
      }
    });
    setters.put("fstrDescriptionWeb", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lanwebnoticecategory.this.fstrDescriptionWeb = (String)value;
      }
    });
  }
  public lanwebnoticecategory() {
    init0();
  }
  ...
  public lanwebnoticecategory with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrWebNoticeCategory;
  public String get_fstrWebNoticeCategory() {
    return fstrWebNoticeCategory;
  }
  public void set_fstrWebNoticeCategory(String fstrWebNoticeCategory) {
    this.fstrWebNoticeCategory = fstrWebNoticeCategory;
  }
  public lanwebnoticecategory with_fstrWebNoticeCategory(String fstrWebNoticeCategory) {
    this.fstrWebNoticeCategory = fstrWebNoticeCategory;
    return this;
  }
  ...
  public lanwebnoticecategory with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lanwebnoticecategory with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lanwebnoticecategory with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  ...
  public lanwebnoticecategory with_fstrDecodeWeb1(String fstrDecodeWeb1) {
    this.fstrDecodeWeb1 = fstrDecodeWeb1;
    return this;
  }
  ...
  public lanwebnoticecategory with_fstrDecodeWeb2(String fstrDecodeWeb2) {
    this.fstrDecodeWeb2 = fstrDecodeWeb2;
    return this;
  }
  ...
  public lanwebnoticecategory with_fstrDescriptionWeb(String fstrDescriptionWeb) {
    this.fstrDescriptionWeb = fstrDescriptionWeb;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lanwebnoticecategory)) {
      return false;
    }
    lanwebnoticecategory that = (lanwebnoticecategory) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrWebNoticeCategory == null ? that.fstrWebNoticeCategory == null : this.fstrWebNoticeCategory.equals(that.fstrWebNoticeCategory));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrWebNoticeCategory = JdbcWritableBridge.readString(2, __dbResults);
    ...
    this.fstrDecodeWeb1 = JdbcWritableBridge.readString(6, __dbResults);
    this.fstrDecodeWeb2 = JdbcWritableBridge.readString(7, __dbResults);
    this.fstrDescriptionWeb = JdbcWritableBridge.readString(8, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrWebNoticeCategory, 2 + __off, -9, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrDecodeWeb1, 6 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrDecodeWeb2, 7 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrDescriptionWeb, 8 + __off, -9, __dbStmt);
    return 8;
  }
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrWebNoticeCategory = null;
    } else {
    this.fstrWebNoticeCategory = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrWebNoticeCategory) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrWebNoticeCategory);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrWebNoticeCategory==null?"\\N":fstrWebNoticeCategory, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrWebNoticeCategory = null; } else {
      this.fstrWebNoticeCategory = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lanwebnoticecategory o = (lanwebnoticecategory) super.clone();
    return o;
  }

  public void clone0(lanwebnoticecategory o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrWebNoticeCategory", this.fstrWebNoticeCategory);
