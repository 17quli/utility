// ORM class for table 'tblnz_ksemployerchosenschemes'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 02:57:33 NZDT 2020
...
public class tblnz_ksemployerchosenschemes extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("flngRelationshipKey", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngRelationshipKey = (Integer)value;
      }
    });
    setters.put("flngVer", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngVer = (Integer)value;
      }
    });
    setters.put("flngVerLast", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngVerLast = (Integer)value;
      }
    });
    setters.put("flngEmployerAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngEmployerAccountKey = (Integer)value;
      }
    });
    setters.put("flngEmployerCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngEmployerCustomerKey = (Integer)value;
      }
    });
    setters.put("flngSchemeAccountKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngSchemeAccountKey = (Integer)value;
      }
    });
    setters.put("flngSchemeCustomerKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngSchemeCustomerKey = (Integer)value;
      }
    });
    setters.put("fdtmCommence", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fdtmCommence = (java.sql.Timestamp)value;
      }
    });
    setters.put("fdtmCease", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fdtmCease = (java.sql.Timestamp)value;
      }
    });
    setters.put("fstrCeaseReason", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fstrCeaseReason = (String)value;
      }
    });
    setters.put("fstrInvalidationReason", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fstrInvalidationReason = (String)value;
      }
    });
    setters.put("fblnValid", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fblnValid = (Integer)value;
      }
    });
    setters.put("flngAttachmentKey", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.flngAttachmentKey = (Integer)value;
      }
    });
    setters.put("fstrWho", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fstrWho = (String)value;
      }
    });
    setters.put("fdtmWhen", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        tblnz_ksemployerchosenschemes.this.fdtmWhen = (java.sql.Timestamp)value;
      }
    });
  }
  public tblnz_ksemployerchosenschemes() {
    init0();
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngRelationshipKey(Integer flngRelationshipKey) {
    this.flngRelationshipKey = flngRelationshipKey;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngVer(Integer flngVer) {
    this.flngVer = flngVer;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngVerLast(Integer flngVerLast) {
    this.flngVerLast = flngVerLast;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngEmployerAccountKey(Integer flngEmployerAccountKey) {
    this.flngEmployerAccountKey = flngEmployerAccountKey;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngEmployerCustomerKey(Integer flngEmployerCustomerKey) {
    this.flngEmployerCustomerKey = flngEmployerCustomerKey;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngSchemeAccountKey(Integer flngSchemeAccountKey) {
    this.flngSchemeAccountKey = flngSchemeAccountKey;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngSchemeCustomerKey(Integer flngSchemeCustomerKey) {
    this.flngSchemeCustomerKey = flngSchemeCustomerKey;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fdtmCommence(java.sql.Timestamp fdtmCommence) {
    this.fdtmCommence = fdtmCommence;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fdtmCease(java.sql.Timestamp fdtmCease) {
    this.fdtmCease = fdtmCease;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fstrCeaseReason(String fstrCeaseReason) {
    this.fstrCeaseReason = fstrCeaseReason;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fstrInvalidationReason(String fstrInvalidationReason) {
    this.fstrInvalidationReason = fstrInvalidationReason;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fblnValid(Integer fblnValid) {
    this.fblnValid = fblnValid;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_flngAttachmentKey(Integer flngAttachmentKey) {
    this.flngAttachmentKey = flngAttachmentKey;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fstrWho(String fstrWho) {
    this.fstrWho = fstrWho;
    return this;
  }
  ...
  public tblnz_ksemployerchosenschemes with_fdtmWhen(java.sql.Timestamp fdtmWhen) {
    this.fdtmWhen = fdtmWhen;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof tblnz_ksemployerchosenschemes)) {
      return false;
    }
    tblnz_ksemployerchosenschemes that = (tblnz_ksemployerchosenschemes) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.flngEmployerAccountKey = JdbcWritableBridge.readInteger(4, __dbResults);
    this.flngEmployerCustomerKey = JdbcWritableBridge.readInteger(5, __dbResults);
    this.flngSchemeAccountKey = JdbcWritableBridge.readInteger(6, __dbResults);
    ...
    this.fstrCeaseReason = JdbcWritableBridge.readString(10, __dbResults);
    this.fstrInvalidationReason = JdbcWritableBridge.readString(11, __dbResults);
    this.fblnValid = JdbcWritableBridge.readInteger(12, __dbResults);
    this.flngAttachmentKey = JdbcWritableBridge.readInteger(13, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeInteger(flngEmployerAccountKey, 4 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngEmployerCustomerKey, 5 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeInteger(flngSchemeAccountKey, 6 + __off, 4, __dbStmt);
    ...
    JdbcWritableBridge.writeString(fstrCeaseReason, 10 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeString(fstrInvalidationReason, 11 + __off, -9, __dbStmt);
    JdbcWritableBridge.writeInteger(fblnValid, 12 + __off, -6, __dbStmt);
    JdbcWritableBridge.writeInteger(flngAttachmentKey, 13 + __off, 4, __dbStmt);
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    tblnz_ksemployerchosenschemes o = (tblnz_ksemployerchosenschemes) super.clone();
  ...
  public void clone0(tblnz_ksemployerchosenschemes o) throws CloneNotSupportedException {
    o.fdtmCommence = (o.fdtmCommence != null) ? (java.sql.Timestamp) o.fdtmCommence.clone() : null;
    o.fdtmCease = (o.fdtmCease != null) ? (java.sql.Timestamp) o.fdtmCease.clone() : null;
    o.fdtmWhen = (o.fdtmWhen != null) ? (java.sql.Timestamp) o.fdtmWhen.clone() : null;
  }
