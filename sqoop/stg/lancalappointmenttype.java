// ORM class for table 'lancalappointmenttype'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Fri Dec 04 01:01:14 NZDT 2020
...
public class lancalappointmenttype extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("fstrLanguage", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        lancalappointmenttype.this.fstrLanguage = (String)value;
      }
    });
    setters.put("fstrAppointmentType", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancalappointmenttype.this.fstrAppointmentType = (String)value;
      }
    });
    setters.put("fstrDecode1", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancalappointmenttype.this.fstrDecode1 = (String)value;
      }
    });
    setters.put("fstrDecode2", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancalappointmenttype.this.fstrDecode2 = (String)value;
      }
    });
    setters.put("fstrDescription", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        lancalappointmenttype.this.fstrDescription = (String)value;
      }
    });
  }
  public lancalappointmenttype() {
    init0();
  }
  ...
  public lancalappointmenttype with_fstrLanguage(String fstrLanguage) {
    this.fstrLanguage = fstrLanguage;
    return this;
  }
  private String fstrAppointmentType;
  public String get_fstrAppointmentType() {
    return fstrAppointmentType;
  }
  public void set_fstrAppointmentType(String fstrAppointmentType) {
    this.fstrAppointmentType = fstrAppointmentType;
  }
  public lancalappointmenttype with_fstrAppointmentType(String fstrAppointmentType) {
    this.fstrAppointmentType = fstrAppointmentType;
    return this;
  }
  ...
  public lancalappointmenttype with_fstrDecode1(String fstrDecode1) {
    this.fstrDecode1 = fstrDecode1;
    return this;
  }
  ...
  public lancalappointmenttype with_fstrDecode2(String fstrDecode2) {
    this.fstrDecode2 = fstrDecode2;
    return this;
  }
  ...
  public lancalappointmenttype with_fstrDescription(String fstrDescription) {
    this.fstrDescription = fstrDescription;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof lancalappointmenttype)) {
      return false;
    }
    lancalappointmenttype that = (lancalappointmenttype) o;
    boolean equal = true;
    equal = equal && (this.fstrLanguage == null ? that.fstrLanguage == null : this.fstrLanguage.equals(that.fstrLanguage));
    equal = equal && (this.fstrAppointmentType == null ? that.fstrAppointmentType == null : this.fstrAppointmentType.equals(that.fstrAppointmentType));
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.fstrAppointmentType = JdbcWritableBridge.readString(2, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(fstrAppointmentType, 2 + __off, -9, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    if (__dataIn.readBoolean()) { 
        this.fstrAppointmentType = null;
    } else {
    this.fstrAppointmentType = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.fstrAppointmentType) { 
        __dataOut.writeBoolean(true);
    } else {
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, fstrAppointmentType);
    }
  ...
  public String toString(DelimiterSet delimiters, boolean useRecordDelim) {
    ...
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
    __sb.append(FieldFormatter.hiveStringReplaceDelims(fstrAppointmentType==null?"\\N":fstrAppointmentType, " ", delimiters));
    __sb.append(fieldDelim);
    // special case for strings hive, replacing delimiters \n,\r,\01 with ' ' from strings
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    if (__cur_str.equals("null")) { this.fstrAppointmentType = null; } else {
      this.fstrAppointmentType = __cur_str;
    }
  ...
  public Object clone() throws CloneNotSupportedException {
    lancalappointmenttype o = (lancalappointmenttype) super.clone();
    return o;
  }

  public void clone0(lancalappointmenttype o) throws CloneNotSupportedException {
  }

  public Map<String, Object> getFieldMap() {
    Map<String, Object> __sqoop$field_map = new HashMap<String, Object>();
    __sqoop$field_map.put("fstrLanguage", this.fstrLanguage);
    __sqoop$field_map.put("fstrAppointmentType", this.fstrAppointmentType);
