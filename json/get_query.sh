...
impala-shell -i ird26au.vsp.sas.com:25003  --var="v1=${interval_minute_from}" --var="v2=${interval_minute_to}" -f "${sql_file}" -k --ssl --ca_cert=/sso/hadoop/cloudera-certs/CACerts/DigiAndSAS-CA.pem  2>>$logfile
