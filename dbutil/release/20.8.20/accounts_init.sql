...
CREATE TABLE party_account_rel (
    ...
    dip_account_id                VARCHAR(30),
    party_acct_rel_type_code      VARCHAR(10),   
    party_acct_rel_type_desc      VARCHAR(50),   
    record_effective_timestamp    TIMESTAMP,
    record_expiry_timestamp       TIMESTAMP,
    record_active_flag            CHAR(1),
...
CREATE TABLE party_account_rel_type (
  party_acct_rel_type_code      VARCHAR(10),
  party_acct_rel_type_desc      VARCHAR(255)
) STORED AS PARQUET;
INSERT INTO party_account_rel_type VALUES (CAST('OWNED' AS VARCHAR(10)), CAST('Owner Of' AS VARCHAR(50)));
...
CAST('Unknown' AS VARCHAR(7)), --  party_ird_number   varchar(10)
...
DROP TABLE mp_source_code;
CREATE TABLE mp_source_code STORED AS PARQUET AS SELECT * FROM dev_refined.mp_source_code;
