...
impala-shell -i ird10139au.vsp.sas.com:25003 --quiet -d ${db_env}_${db_layer}  -q "delete from mdm" --query_option="sync_ddl=1" -k --ssl --ca_cert=/sso/hadoop/cloudera-certs/CACerts/sas-hadoop-truststore.pem

impala-shell -i ird10139au.vsp.sas.com:25003 --quiet -d ${db_env}_${db_layer} -q "truncate table mdm_stg" --query_option="sync_ddl=1" -k --ssl --ca_cert=/sso/hadoop/cloudera-certs/CACerts/sas-hadoop-truststore.pem
