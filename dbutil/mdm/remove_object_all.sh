...
./remove_object.sh $db_env $db_layer full_view $tblist
./remove_object.sh $db_env $db_layer restricted_view $tblist
./remove_object.sh $db_env $db_layer table $tblist
./remove_object.sh $db_env $db_layer mdm $tblist
