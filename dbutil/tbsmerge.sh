...
if ($0 != "PARTITIONED BY ("  && $0 != "(" && $0!=")")
	...
	done< <(impala-shell -B --quiet -i ird10139au.vsp.sas.com:25003  -d $deployment_db --var="v1=${v1}" --var="v2=${v2}" --var="v3=${v3}" --var="v4=${v4}" --var="v5=${v5}" -f if_merge.sql -k --ssl --ca_cert=/sso/hadoop/cloudera-certs/CACerts/sas-hadoop-truststore.pem)
