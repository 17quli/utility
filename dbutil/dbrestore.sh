...
impala-shell -B -i ird10139au.vsp.sas.com:25003  -q "show tables $like" -d ${source_db}  -k --ssl --ca_cert=/sso/hadoop/cloudera-certs/CACerts/sas-hadoop-truststore.pem > $tbllist
