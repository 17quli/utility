...
where 
nvl(cl1.fstrcustomerlevel, 'STD') = 'STD' and 
nvl(cl2.fstrcustomerlevel, 'STD') = 'STD' and 
nvl(cl1.record_active_flag, 'Y') = 'Y' and 
nvl(cl1.record_deleted_flag, 'N') = 'N' AND 
nvl(cl2.record_active_flag, 'Y') = 'Y' AND 
nvl(cl2.record_deleted_flag, 'N') = 'N';
