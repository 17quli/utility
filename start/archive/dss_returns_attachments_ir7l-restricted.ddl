create view ${var:view_db}.dss_returns_attachments_ir7l
as select 
z.ird_number,
z.location_number,
...
z.non_allow_deds_cfwd_100859,
z.non_allow_deds_bfwd_100858,
...
from ${var:source_db}.dss_returns_attachments_ir7l z
...
on cast(z.attachment_ird_number as int) = cast(sc1.ird_number as int) 
