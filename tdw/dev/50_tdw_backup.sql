upsert into ${var:source_db}.tdw_validation(raw_table_name,environment,batch_number,tdw_table_name,raw_record_count)
select '${var:app_tbl_name}','${var:env}',${var:batch_number},'${var:tdw_tbl_name}',count(*)  from  ${var:target_db}.${var:app_tbl_name};
create table  ${var:source_db}.${var:app_tbl_name}_${var:yyyymmdd} stored as parquet
as select * from  ${var:target_db}.${var:app_tbl_name};
