...
cast(fstrcalculationmethod as VARCHAR(8)) as fstrcalculationmethod,
cast(fstrname as VARCHAR(510)) as fstrname,
cast(fstrstockcode as VARCHAR(100)) as fstrstockcode,
cast(fstrcountry as VARCHAR(6)) as fstrcountry,
cast(fcurmethodmarketvalue as DECIMAL(19,4)) as fcurmethodmarketvalue,
