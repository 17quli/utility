...
cast(fcurimpopeningbalance as DECIMAL(19,4)) as fcurimpopeningbalance,
cast(fcurimpincometaxcredit as DECIMAL(19,4)) as fcurimpincometaxcredit,
cast(fcurimpfdpcredit as DECIMAL(19,4)) as fcurimpfdpcredit,
cast(fcurimprwtcredit as DECIMAL(19,4)) as fcurimprwtcredit,
cast(fcurimpimputationcredit as DECIMAL(19,4)) as fcurimpimputationcredit,
cast(fcurimpothercredits as DECIMAL(19,4)) as fcurimpothercredits,
cast(fcurimptotalcredits as DECIMAL(19,4)) as fcurimptotalcredits,
cast(fcurimpincometaxdebit as DECIMAL(19,4)) as fcurimpincometaxdebit,
cast(fcurimpfdpdebit as DECIMAL(19,4)) as fcurimpfdpdebit,
cast(fcurimpimputationdebit as DECIMAL(19,4)) as fcurimpimputationdebit,
cast(fcurimpotherdebits as DECIMAL(19,4)) as fcurimpotherdebits,
cast(fcurimptotaldebits as DECIMAL(19,4)) as fcurimptotaldebits,
cast(fcurimpclosingbalance as DECIMAL(19,4)) as fcurimpclosingbalance,
cast(fcurimpadjustments as DECIMAL(19,4)) as fcurimpadjustments,
cast(fcurimpfurtherincometax as DECIMAL(19,4)) as fcurimpfurtherincometax,
cast(fcurimppenaltytax as DECIMAL(19,4)) as fcurimppenaltytax,
cast(fcurimptotalpayable as DECIMAL(19,4)) as fcurimptotalpayable,
