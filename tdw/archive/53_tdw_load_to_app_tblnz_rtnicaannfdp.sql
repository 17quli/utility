...
cast(fcurfdpopeningbalance as DECIMAL(19,4)) as fcurfdpopeningbalance,
cast(fcurfdppaid as DECIMAL(19,4)) as fcurfdppaid,
cast(fcurfdpcreditsrec as DECIMAL(19,4)) as fcurfdpcreditsrec,
cast(fcurfdptotalcredits as DECIMAL(19,4)) as fcurfdptotalcredits,
cast(fcurfdpcreditspaid as DECIMAL(19,4)) as fcurfdpcreditspaid,
cast(fcurfdprefunded as DECIMAL(19,4)) as fcurfdprefunded,
cast(fcurfdpotherdebits as DECIMAL(19,4)) as fcurfdpotherdebits,
cast(fcurfdptotaldebits as DECIMAL(19,4)) as fcurfdptotaldebits,
cast(fcurfdptotalbalance as DECIMAL(19,4)) as fcurfdptotalbalance,
cast(fcurfdptransfer as DECIMAL(19,4)) as fcurfdptransfer,
cast(fcurfdpclosingbalance as DECIMAL(19,4)) as fcurfdpclosingbalance,
cast(fcurfdpimppenaltytax as DECIMAL(19,4)) as fcurfdpimppenaltytax,
cast(fcurfdptotalpayable as DECIMAL(19,4)) as fcurfdptotalpayable,
