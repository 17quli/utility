...
cast(fcurauthopeningbalance as DECIMAL(19,4)) as fcurauthopeningbalance,
cast(fcurauthincometaxcredit as DECIMAL(19,4)) as fcurauthincometaxcredit,
cast(fcurauthfdpcredit as DECIMAL(19,4)) as fcurauthfdpcredit,
cast(fcurauthrwtcredit as DECIMAL(19,4)) as fcurauthrwtcredit,
cast(fcurauthimputationcredit as DECIMAL(19,4)) as fcurauthimputationcredit,
cast(fcurauthothercredits as DECIMAL(19,4)) as fcurauthothercredits,
cast(fcurauthtotalcredits as DECIMAL(19,4)) as fcurauthtotalcredits,
cast(fcurauthincometaxdebit as DECIMAL(19,4)) as fcurauthincometaxdebit,
cast(fcurauthfdpdebit as DECIMAL(19,4)) as fcurauthfdpdebit,
cast(fcurauthmaoridebit as DECIMAL(19,4)) as fcurauthmaoridebit,
cast(fcurauthotherdebits as DECIMAL(19,4)) as fcurauthotherdebits,
cast(fcurauthtotaldebits as DECIMAL(19,4)) as fcurauthtotaldebits,
cast(fcurauthfurtherincometax as DECIMAL(19,4)) as fcurauthfurtherincometax,
cast(fcurauthclosingbalance as DECIMAL(19,4)) as fcurauthclosingbalance,
cast(fcurauthpenaltytax as DECIMAL(19,4)) as fcurauthpenaltytax,
cast(fcurauthtotalpayable as DECIMAL(19,4)) as fcurauthtotalpayable,
...
select raw_table_name as raw,environment as env,batch_number as batch,raw_record_count as raw_rc,tdw_record_count as tdw_rc,tdw_unique_key_count as tdw_ukc,tdw_multiple_key_count as tdw_mkc,tdw_min_effective_from,tdw_max_effective_from,raw_record_count_post_inc as raw_rc_inc,low_date_count as lwm_rc,high_date_count as hwm_rc,fdtmwhen_low_date_count fdtmwhen_lwm_rc 
