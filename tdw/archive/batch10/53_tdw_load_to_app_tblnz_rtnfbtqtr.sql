...
cast(fblnalternaterate1 as SMALLINT) as fblnalternaterate1,
cast(fblnalternaterate2 as SMALLINT) as fblnalternaterate2,
...
cast(fblngstamend as SMALLINT) as fblngstamend,
