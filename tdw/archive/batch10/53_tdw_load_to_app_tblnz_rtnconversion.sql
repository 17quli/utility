...
cast(fblnrules as SMALLINT) as fblnrules,
cast(fblnreturnfiled as SMALLINT) as fblnreturnfiled,
cast(fblnduedateissues as SMALLINT) as fblnduedateissues,
cast(fcurcnvtax as DECIMAL(19,4)) as fcurcnvtax,
cast(fcurlatefilepenalty as DECIMAL(19,4)) as fcurlatefilepenalty,
cast(fcurlatefilepenaltyremission as DECIMAL(19,4)) as fcurlatefilepenaltyremission,
cast(fcurlatepaymentpenalty as DECIMAL(19,4)) as fcurlatepaymentpenalty,
cast(fcurlatepaypenaltyremission as DECIMAL(19,4)) as fcurlatepaypenaltyremission,
cast(fcurinterest as DECIMAL(19,4)) as fcurinterest,
cast(fcurinterestremission as DECIMAL(19,4)) as fcurinterestremission,
cast(fdtminteresteffective as TIMESTAMP) as fdtminteresteffective,
cast(fcuradjustment as DECIMAL(19,4)) as fcuradjustment,
cast(fdtmlegacypnidate as TIMESTAMP) as fdtmlegacypnidate,
cast(fdtmcreditinterestthrudate as TIMESTAMP) as fdtmcreditinterestthrudate,
cast(fdtmlaststatementdate as TIMESTAMP) as fdtmlaststatementdate,
cast(fstraccountreviewtype as VARCHAR(8)) as fstraccountreviewtype,
cast(fstrreturncategory as VARCHAR(8)) as fstrreturncategory,
cast(fintreturnversion as SMALLINT) as fintreturnversion,
cast(fblnaudit as SMALLINT) as fblnaudit,
cast(flngcnvsequence as INT) as flngcnvsequence,
cast(fblnoriginalconversion as SMALLINT) as fblnoriginalconversion,
