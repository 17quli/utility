...
cast(fcurslthreshold as DECIMAL(19,4)) as fcurslthreshold,
cast(fcurslurt as DECIMAL(19,4)) as fcurslurt,
cast(fcursladjnetincome as DECIMAL(19,4)) as fcursladjnetincome,
cast(fcurslliableincome as DECIMAL(19,4)) as fcurslliableincome,
cast(fcurslassessment as DECIMAL(19,4)) as fcurslassessment,
cast(fcurslinterimamount as DECIMAL(19,4)) as fcurslinterimamount,
cast(fbln215indicator as SMALLINT) as fbln215indicator,
cast(fblnmanualoverride as SMALLINT) as fblnmanualoverride,
cast(fintforwarddatenotice as SMALLINT) as fintforwarddatenotice,
