...
CAST(FBLNIRREGULARFILER AS SMALLINT) AS fblnirregularfiler,
CAST(FSTRIRREGULARNOTE AS VARCHAR(510)) AS fstrirregularnote,
CAST(FSTRSITENUMBER AS VARCHAR(100)) AS fstrsitenumber,
CAST(FSTRLICENCENUMBER AS VARCHAR(100)) AS fstrlicencenumber,
