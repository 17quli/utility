...
CAST(FSTRCEASEREASON AS VARCHAR(100)) AS fstrCeaseReason,
CAST(FDTMAPPRCPTDATE AS TIMESTAMP) AS fdtmAppRcptDate,
CAST(FDTMCHILDDUEBIRTHDATE AS TIMESTAMP) AS fdtmChildDueBirthDate,
CAST(FSTRPARTNERIRDNUMBER AS VARCHAR(100)) AS fstrPartnerIRDNumber,
