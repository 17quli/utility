...
cast(fcurschooldonations as DECIMAL(19,4)) as fcurschooldonations,
cast(fcurreligiousdonations as DECIMAL(19,4)) as fcurreligiousdonations,
cast(fcurremainingdonations as DECIMAL(19,4)) as fcurremainingdonations,
cast(fcurtotalreceipt as DECIMAL(19,4)) as fcurtotalreceipt,
cast(fcurcareandhousepayments as DECIMAL(19,4)) as fcurcareandhousepayments,
cast(fcurcareandhousecredits as DECIMAL(19,4)) as fcurcareandhousecredits,
cast(fcurfinaltotal as DECIMAL(19,4)) as fcurfinaltotal,
cast(fstrpartnerird as VARCHAR(18)) as fstrpartnerird,
cast(fstrtransferird as VARCHAR(18)) as fstrtransferird,
cast(fcurtransferamount as DECIMAL(19,4)) as fcurtransferamount,
cast(fblnwaitingonincome as SMALLINT) as fblnwaitingonincome,
