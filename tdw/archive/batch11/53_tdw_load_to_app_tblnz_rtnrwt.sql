...
cast(fstrpayeeirdnumber as VARCHAR(18)) as fstrpayeeirdnumber,
cast(fdtmperiod as TIMESTAMP) as fdtmperiod,
cast(fblnjointownership as SMALLINT) as fblnjointownership,
cast(fcurgrossdividends as DECIMAL(19,4)) as fcurgrossdividends,
cast(fcurimputationcredits as DECIMAL(19,4)) as fcurimputationcredits,
cast(fcurfdpcredits as DECIMAL(19,4)) as fcurfdpcredits,
cast(fcurrwtdeducted as DECIMAL(19,4)) as fcurrwtdeducted,
cast(fstrpayerirdnumber as VARCHAR(18)) as fstrpayerirdnumber,
