...
'TBLNZ_RTNNITSUP',
'TBLBCMFUND',
'TBLNZ_EOTATTRIBUTESHISTORY',
'TBLNZ_RTNAIL',
'TBLNZ_RTNAILE',
'TBLNZ_RTNAILEINCOMEINFO',
'TBLNZ_RTNAILELINEITEM',
'TBLNZ_RTNCONVERSION',
'TBLNZ_RTNDWT',
'TBLNZ_RTNDWTE',
'TBLNZ_RTNDWTEINCOMEINFO',
'TBLNZ_RTNDWTELINEITEM',
'TBLNZ_RTNFAMCONVERSION',
'TBLNZ_RTNFBTQTR',
'TBLNZ_RTNFBTSHR',
'TBLNZ_RTNGMD',
'TBLNZ_RTNGSTCONVERTED',
'TBLNZ_RTNIITEXCLUDEDOVERSEAS',
'TBLNZ_RTNIITPARTYEAR',
'TBLNZ_RTNIITSTUDENTLOAN',
'TBLNZ_RTNITNBENLINEITEM',
'TBLNZ_RTNJOINTACCOUNTHOLDERS',
'TBLNZ_RTNKSSGVC',
'TBLNZ_RTNLODGEMENT',
'TBLNZ_RTNLODGEMENTMAPPING',
'TBLNZ_RTNMACAMA',
'TBLNZ_RTNNITPRTATTRIBUTIONP',
'TBLNZ_RTNNRTELINEITEM',
'TBLNZ_RTNNRTP',
'TBLNZ_RTNPROVISIONAL',
'TBLNZ_RTNPRS',
'TBLNZ_RTNREBRCP',
'TBLNZ_RTNRLTTABLE',
'TBLNZ_RTNRWTP',
'TBLNZ_RTNRWTS',
'TBLNZ_RTNSOAADJUSTMENTS',
'TBLNZ_RTNTOSUBMISSON',
'TBLNZ_STATEMENTOFACTIVITY',
'TBLNZ_TAILOREDTAXZERORATE',
'TBLNZ_TPADEPOSIT',
'TBLNZ_TPADEPOSITTOPAYMENT',
'TBLRETURNTRANSFER',
-------- TDW JOBS some are duplicates of app source_object_name
'TBL_BCMFUND',
'TBL_NZ_RTNAIL',
'TBLNZ_RTNAILE',
'TBL_NZ_RTNCONVERSION',
'TBL_NZ_RTNDWT',
'TBL_NZ_RTNDWTE',
'TBL_NZ_RTNFBTQTR',
'TBLNZ_RTNFBTSHR',
'TBL_NZ_RTNGMD',
'TBL_NZ_RTNIITEXCLOVRSC',
'TBL_NZ_RTNIITSTUDLOAN',
'TBL_NZ_RTNMACAMA',
'TBL_NZ_RTNRWTS'
);
