...
(
'LANNZ_AMENDREASON',
'LANNZ_CLIENTLISTACCESSLEVEL',
'LANREASONRTNADJ',
'TBLAUDITPERIOD',
'TBLCOLLECTDETAIL',
'TBLCOLLECTSTAGETOSTAGE',
'TBLDOCTRN',
'TBLGARNISHTODEBTSOURCE',
'TBLNZ_ACCAILSECURITIES',
'TBLNZ_ACCGMD',
'TBLNZ_ACCKIWISAVERMEMBERINFO',
'TBLNZ_ACCOUNTDATEHISTORY',
'TBLNZ_ACCPPL',
'TBLNZ_BILLITEMTOSTATEMENT',
'TBLNZ_CAMPAIGNTREATMENTS',
'TBLNZ_CASECOLNEGOTIATION',
'TBLNZ_CSTINDINFO',
'TBLNZ_DEDUCTIONLETTERQUEUE',
'TBLNZ_FAMCHANGELOG',
'TBLNZ_FAMCHILDSUPPORTACTUALS',
'TBLNZ_FAMEVENTLOG',
'TBLNZ_FAMIWTC',
'TBLNZ_FAMMFTC',
'TBLNZ_FAMPROTECTEDFTC',
'TBLNZ_INDICATORTAXPREPPROFILE',
'TBLNZ_INGJOINTLYLIABLE',
'TBLNZ_KSSHOLDTILLDATE',
'TBLNZ_KSSPRORATAPOSTING',
'TBLNZ_LNKKSFADM',
'TBLNZ_PAYMENTADDITIONALINFO',
'TBLNZ_RATXNDEBTORAGINGPERIOD',
'TBLNZ_RATXNDEBTORAGINGDETAIL',
'TBLNZ_RELATIONSHIPCHILDPRD',
'TBLNZ_RELATIONSHIPROLEREVERSE',
'TBLNZ_RTNIITCOEXISTENCE',
'TBLNZ_RTNSLSOBLIGATIONS',
'TBLNZ_STUDYLINKENROLMAINTLOG',
'TBLNZ_STUDYLINKCEASELOG',
'TBLNZ_TAILOREDTAX',
'TBLRECOVERY',
'TBLRECOVERYAMOUNT',
'TBLTRANSOFFSETDETAIL',
'TBLWEBSESSION',
 --TDW tables
'TBL_NZ_ACAILSECURTS',
'TBL_NZ_ACCPPL',
'TBL_RECOVERY',
'TBL_NZ_RTNIITCOEXIST',
'TBL_NZ_FAMCHANGELOG', 
'TBLNZ_CASECOLNEGOTIATION',
'TBL_NZ_ACCGMD',
-- round 2 tables
'TBLNZ_CUSTOMSALS',
'TBLNZ_CUSTOMSPOI',
'INSTALMENT_AGMT_ELEMENTS',
'INSTALMENT_SRC_PLANS_SUM',
'LANIDTYPE',
'LANNZ_PROVISIONALTAXMETHOD',
'RETURNS_KEYPOINTS_IR9',
'TBLNZ_FAMLINKMODIFICATION',
'TBLNZ_FAMMSDADMINISTRATION',
'TBLNZ_LINKPCGTOPARTNER',
'TBLNZ_RELATIONSHIPPARTNERPRD',
'TBLNZ_RTNNITPRTATTRIBUTIONL',
'EDW_VOICE_AGENT',
--TDW tables
'TBLNZ_FAMLINKMODIFICATION'
);
...
BEGIN
LCF.LCF_UPDATE.VALIDATE_REG_DATA(p_env=>'dev',
                                 p_user=>'ird0dxm');
Commit;                       
END;
