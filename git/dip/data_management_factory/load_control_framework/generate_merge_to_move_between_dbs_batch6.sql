...
'CLIENT_AGENTS',
'CS_ELIGIBLE_CHILDREN',
'CS_CHILDREN',
'TBLAUDITDETAIL',
'TBLAUDITGROUP',
'TBLAUDITGROUPCUSTOMER',
'TBLNZ_RTNFINANCIALSTATEMENTS',
'TBLNZ_RTNLINEITEM',
'TBLNZ_RTNNIT',
'LANCOUNTRY',
'RFRPROFILETYPE',
'TBLNZ_RTNPIEANNLINEITEM',
'TBLBCMCERTIFICATE',
'TBLNZ_BCMPAYERINFO',
'TBLNZ_RTNITNSHRLINEITEM',
'TBLTRANSACTION',
'TBLAUDITGROUPDETAIL',
'TBLWORKDETAILCOMPLETED',
--'TBLNZ_AUDSELATTRS',
'TBLNZ_AUDSELECTIONATTRIBUTES',
'TBLAUDIT',
'TBLWORKDETAIL',
'RFRCOUNTRY',
'TBLBCMCERTIFICATETOENTITY',
'TBLNZ_FAMDISBURSEMENT',
'TBLNZ_SMS',
'TBLNZ_ACCGSTACCOUNTINGBASIS',
'TBLNZ_RTNFAMSQUAREUP',
'TBLNZ_FAMENTITLEMENTPERIODS',
'TBLADDRESSRECORD', -- Rel 2.1 object registration fix
'TBLNAMERECORD', -- Rel 2.1 object registration fix
--
...
'TBL_NZ_RTNLINEITEM',
'TBL_NZ_RTNNIT',
'TBL_NZ_RTNFINANSTMTS',
'TBL_AUDITGROUP',
'TBL_NZ_RTNFAMSQUAREUP',
'TBL_NZ_AUDSELECTNATTRS'
);
