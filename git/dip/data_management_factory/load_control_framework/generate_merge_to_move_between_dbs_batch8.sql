...
(
-- add batch 8 tables here (50 tables)
'TBLBALANCE',
'TBLNZ_KSSCONTRIBUTIONBALANCE',
'TBLNZ_KSSCONTRIBUTIONDETAIL',
'TBLAUDITGROUPTOAUDIT',
'TBLBANKACCOUNTPAYMENT',
'TBLCOLLECTPAYMENTPLANBILLITEM',
'TBLCOLLECTPAYMENTPLANSCHEDULE',
'TBLGARNISHTOGARNISHEE',
'TBLNZ_ACCKSFINFO',
'TBLNZ_ACCKSSINFO',
'TBLNZ_ACCSLS',
'TBLNZ_ACCSLSHISTORY',
'TBLNZ_CASSLSRECALL',
'TBLNZ_GARNISHTOPBI',
'TBLNZ_INCORRECTDEDCASEDETAILS',
'TBLNZ_KSEMPLOYERCHOSENSCHEMES',
'TBLNZ_KSFDEFAULTSCHEME',
'TBLNZ_KSSCONTRIBUTION',
'TBLNZ_KSSDEFAULTSCHEMEALLOC',
'TBLNZ_KSSLINEITEM',
'TBLNZ_KSSMEMBERTOSCHEME',
'TBLNZ_KSSPARTIALGVCCLAWBACK',
'TBLNZ_KSSPRORATAINTEREST',
'TBLNZ_KSSRESIDUAL',
'TBLNZ_KSSWITHDRAWAL',
'TBLNZ_LINKMAILREDIRECT',
'TBLNZ_RTNSLSOBLIGATIONS2013',
'TBLNZ_RTNSLSOBLIGATIONSNZB',
'TBLNZ_RTNSLSOBLIGATIONSOBB',
'TBLNZ_SLSBORROWERTYPE',
'TBLNZ_SLSCUSTOMSMOVEMENT',
'TBLNZ_SLSUNLINKEDDEDUCTIONS',
'TBLNZ_SLSWORLDWIDEINCOME',
'TBLNZ_STUDYLINKMAINTAINLOG',
'TBLNZ_STUDYLINKOUT',
'TBLNZ_STUDYLINKVALIDATELOG',
'TBLNZ_TRSTOBORROWERTYPE',
'TBLRFNREFUND',
'TBLRFNREFUNDTRANSACTION',
'LANINDICATORLEVEL',
'LANINDICATORREASON',
'LANNZ_KSSCONTRIBDETAILTYPE',
'LANNZ_KSSCONTRIBREVERSALREASON',
'LANNZ_KSSCONTRIBUTIONSTATUS',
'LANNZ_KSSCONTRIBUTIONTYPE',
'LANNZ_KSSFINHARDSHIPREASON',
'LANNZ_KSSMEMBERCEASEREASON',
'LANNZ_KSSSCHEMECHOICETYPE',
'LANNZ_KSSWITHDRAWALREASON',
'LANNZ_SLSBORROWERTYPE',
'TBLPERIODBILLITEM', 
'LANNZ_EMPLOYERTYPE',
'LANNZ_CUSTOMERCLASS',
'RFRNZ_FILING'
...
'LANNZ_KSSWITHDRAWALREASON',
'LANNZ_SLSBORROWERTYPE',
'TBLPERIODBILLITEM', -- for Mike O
-- Prod fixes for new columns
'LANNZ_EMPLOYERTYPE',
'LANNZ_CUSTOMERCLASS',
'RFRNZ_FILING'
);
  
-- Before you run this step check whether the system_schema has the correct entries for the tables you are registering.
For **  Test Only run ** 
load_system_schema_nzs.sql to load entries to the system_schema table.
...
update object set target_db = 'prod_raw'
where target_db = 'DEV_RAW';
--We updated 12 records which had an incorrect target_db
