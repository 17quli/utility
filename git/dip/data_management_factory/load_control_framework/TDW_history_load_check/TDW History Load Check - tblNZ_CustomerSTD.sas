...
/********************************************************************************/
/*TDW*/
%let tdw_table_name = TBL_NZ_CUSTOMERSTD; 
%let tdw_table_key = flngDocKey;

/*START*/
%let start_table_name = tblNZ_CustomerStd; 
%let start_table_key = flngDocKey;

/*DIP Raw*/
%let raw_table_name = app_tblNZ_CustomerStd; 
%let raw_table_key = flngDocKey;
