/**************************************************************************** 
 * Job:             tdw_tbl_customer P2H2                 A5IKCEC7.BR0000K5 * 
 * Description:                                                             * 
 *                                                                          * 
 ...
 *                                                                          * 
 * Source Table:    TBL_CUSTOMER - edwtdw.TBL_CUSTOMER    A5IKCEC7.BE0000XD * 
 * Target Table:    tdw_tbl_customer -                    A5IKCEC7.BE0000XC * 
 *                   impraw.tdw_tbl_customer                                * 
 *                                                                          * 
 * Generated on:    Wednesday, October 30, 2019 10:59:59 AM NZDT            * 
...
%let jobID = %quote(A5IKCEC7.BR0000K5);
%let etls_jobName = %nrquote(tdw_tbl_customer P2H2);
...
/*==========================================================================* 
 * Step:            Change Extract                        A5IKCEC7.BT000AF4 * 
...
%let transformID = %quote(A5IKCEC7.BT000AF4);
%let trans_rc = 0;
...
%let SYSLAST = %nrquote(edwtdw.TBL_CUSTOMER); 

%let _INPUT_count = 1; 
%let _INPUT = edwtdw.TBL_CUSTOMER;
...
%let _INPUT_path = %nrquote(/IRD/DIP Data Management/3000 Repositories/EDW/EDW TDW/TBL_CUSTOMER%(Table%));
%let _INPUT_type = 1;
%let _INPUT_label = %nrquote();

%let _Source = edwtdw.TBL_CUSTOMER;
...
%let _Source_path = %nrquote(/IRD/DIP Data Management/3000 Repositories/EDW/EDW TDW/TBL_CUSTOMER%(Table%));
%let _Source_type = 1;
%let _Source_label = %nrquote();

%let _OUTPUT_count = 1; 
%let _OUTPUT = impraw.tdw_tbl_customer;
...
%let _OUTPUT_path = %nrquote(/IRD/DIP Data Management/3000 Repositories/EDW/EDW TDW/tdw_tbl_customer%(Table%));
%let _OUTPUT_type = 1;
...
%let _OUTPUT_col0_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col2_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col3_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col3_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col4_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col5_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col6_table = impraw.tdw_tbl_customer;
%let _OUTPUT_col6_length = 8;
%let _OUTPUT_col6_type = ;
%let _OUTPUT_col6_format = 20.;
%let _OUTPUT_col6_informat = 20.;
%let _OUTPUT_col6_label = %nrquote(flngcustomerlevel);
%let _OUTPUT_col6_input0 = FLNGCUSTOMERLEVEL;
%let _OUTPUT_col6_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col7_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col8_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col9_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col9_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col10_table = impraw.tdw_tbl_customer;
%let _OUTPUT_col10_length = 8;
%let _OUTPUT_col10_type = ;
%let _OUTPUT_col10_format = 20.;
%let _OUTPUT_col10_informat = 20.;
%let _OUTPUT_col10_label = %nrquote(flngcustomerversion);
%let _OUTPUT_col10_input0 = FLNGCUSTOMERVERSION;
%let _OUTPUT_col10_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col11_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col11_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col12_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col12_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _OUTPUT_col13_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col14_input0_table = edwtdw.TBL_CUSTOMER;
%let _OUTPUT_col14_exp = ;
%let _OUTPUT_col14_input = FSTRWHO;
%let _OUTPUT_col14_input_count = 1;
%let _OUTPUT_col15_name = effective_from;
%let _OUTPUT_col15_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col15_label = %nrquote(effective_from);
%let _OUTPUT_col15_input0 = EFFECTIVE_FROM;
%let _OUTPUT_col15_input0_table = edwtdw.TBL_CUSTOMER;
%let _OUTPUT_col15_exp = ;
%let _OUTPUT_col15_input = EFFECTIVE_FROM;
%let _OUTPUT_col15_input_count = 1;
%let _OUTPUT_col16_name = effective_to;
%let _OUTPUT_col16_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col16_label = %nrquote(effective_to);
%let _OUTPUT_col16_input0 = EFFECTIVE_TO;
%let _OUTPUT_col16_input0_table = edwtdw.TBL_CUSTOMER;
%let _OUTPUT_col16_exp = ;
%let _OUTPUT_col16_input = EFFECTIVE_TO;
%let _OUTPUT_col16_input_count = 1;
%let _OUTPUT_col17_name = current_rec_flag;
%let _OUTPUT_col17_table = impraw.tdw_tbl_customer;
%let _OUTPUT_col17_length = 2;
%let _OUTPUT_col17_type = $;
%let _OUTPUT_col17_format = $2.;
%let _OUTPUT_col17_informat = $2.;
%let _OUTPUT_col17_label = %nrquote(current_rec_flag);
%let _OUTPUT_col17_input0 = CURRENT_REC_FLAG;
%let _OUTPUT_col17_input0_table = edwtdw.TBL_CUSTOMER;
%let _OUTPUT_col17_exp = ;
%let _OUTPUT_col17_input = CURRENT_REC_FLAG;
%let _OUTPUT_col17_input_count = 1;
%let _OUTPUT_col18_name = record_effective_timestamp;
%let _OUTPUT_col18_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col19_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col20_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col21_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col22_table = impraw.tdw_tbl_customer;
...
%let _OUTPUT_col23_table = impraw.tdw_tbl_customer;
...
%let _target = impraw.tdw_tbl_customer;
...
%let _target_path = %nrquote(/IRD/DIP Data Management/3000 Repositories/EDW/EDW TDW/tdw_tbl_customer%(Table%));
%let _target_type = 1;
...
%let _target_col0_table = impraw.tdw_tbl_customer;
...
%let _target_col2_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col3_table = impraw.tdw_tbl_customer;
...
%let _target_col3_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col4_table = impraw.tdw_tbl_customer;
...
%let _target_col5_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col6_table = impraw.tdw_tbl_customer;
%let _target_col6_length = 8;
%let _target_col6_type = ;
%let _target_col6_format = 20.;
%let _target_col6_informat = 20.;
%let _target_col6_label = %nrquote(flngcustomerlevel);
%let _target_col6_input0 = FLNGCUSTOMERLEVEL;
%let _target_col6_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col7_table = impraw.tdw_tbl_customer;
...
%let _target_col8_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col9_table = impraw.tdw_tbl_customer;
...
%let _target_col9_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col10_table = impraw.tdw_tbl_customer;
%let _target_col10_length = 8;
%let _target_col10_type = ;
%let _target_col10_format = 20.;
%let _target_col10_informat = 20.;
%let _target_col10_label = %nrquote(flngcustomerversion);
%let _target_col10_input0 = FLNGCUSTOMERVERSION;
%let _target_col10_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col11_table = impraw.tdw_tbl_customer;
...
%let _target_col11_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col12_table = impraw.tdw_tbl_customer;
...
%let _target_col12_input0_table = edwtdw.TBL_CUSTOMER;
...
%let _target_col13_table = impraw.tdw_tbl_customer;
...
%let _target_col14_input0_table = edwtdw.TBL_CUSTOMER;
%let _target_col14_exp = ;
%let _target_col14_input = FSTRWHO;
%let _target_col14_input_count = 1;
%let _target_col15_name = effective_from;
%let _target_col15_table = impraw.tdw_tbl_customer;
...
%let _target_col15_label = %nrquote(effective_from);
%let _target_col15_input0 = EFFECTIVE_FROM;
%let _target_col15_input0_table = edwtdw.TBL_CUSTOMER;
%let _target_col15_exp = ;
%let _target_col15_input = EFFECTIVE_FROM;
%let _target_col15_input_count = 1;
%let _target_col16_name = effective_to;
%let _target_col16_table = impraw.tdw_tbl_customer;
...
%let _target_col16_label = %nrquote(effective_to);
%let _target_col16_input0 = EFFECTIVE_TO;
%let _target_col16_input0_table = edwtdw.TBL_CUSTOMER;
%let _target_col16_exp = ;
%let _target_col16_input = EFFECTIVE_TO;
%let _target_col16_input_count = 1;
%let _target_col17_name = current_rec_flag;
%let _target_col17_table = impraw.tdw_tbl_customer;
%let _target_col17_length = 2;
%let _target_col17_type = $;
%let _target_col17_format = $2.;
%let _target_col17_informat = $2.;
%let _target_col17_label = %nrquote(current_rec_flag);
%let _target_col17_input0 = CURRENT_REC_FLAG;
%let _target_col17_input0_table = edwtdw.TBL_CUSTOMER;
%let _target_col17_exp = ;
%let _target_col17_input = CURRENT_REC_FLAG;
%let _target_col17_input_count = 1;
%let _target_col18_name = record_effective_timestamp;
%let _target_col18_table = impraw.tdw_tbl_customer;
...
%let _target_col19_table = impraw.tdw_tbl_customer;
...
%let _target_col20_table = impraw.tdw_tbl_customer;
...
%let _target_col21_table = impraw.tdw_tbl_customer;
...
%let _target_col22_table = impraw.tdw_tbl_customer;
...
%let _target_col23_table = impraw.tdw_tbl_customer;
