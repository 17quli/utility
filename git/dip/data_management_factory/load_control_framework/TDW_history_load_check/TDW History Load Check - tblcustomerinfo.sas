...
/********************************************************************************/
/*TDW*/
%let tdw_table_name = TBL_CUSTOMERINFO; 
%let tdw_table_key = CUSTOMER_KEY;

/*START*/
%let start_table_name = tblcustomerinfo; 
%let start_table_key = flngCustomerKey;

/*DIP Raw*/
%let raw_table_name = app_tblcustomerinfo; 
%let raw_table_key = flngCustomerKey;
