create view lab_fcp_raw_restricted_access.dss_returns_keypoints_ir4p
AS SELECT
z.IRD_NUMBER,
z.LOCATION_NUMBER,
...
z.PRE_ENCRIPTION_IRD_NUMBER_1000,
z.PRE_ENCRIPTION_LOCATION_NBR_10,
z.QCET_PAYABLE_100477,
z.STANDARD_DISCLAIMER_APPLIES_10,
...
FROM lab_fcp_raw.returns_keypoints_ir4p z
