...
DROP VIEW IF EXISTS vw_account_dim;
DROP VIEW IF EXISTS vw_account_gst_dim;
DROP VIEW IF EXISTS vw_account_inc_dim;
DROP VIEW IF EXISTS vw_account_pay_dim;
DROP VIEW IF EXISTS vw_account_pie_dim;
DROP VIEW IF EXISTS vw_party_account_rel;
DROP VIEW IF EXISTS vw_party_account_rel_type;
...
CREATE VIEW vw_account_gst_dim AS 
...
CREATE VIEW vw_account_inc_dim AS 
...
CREATE VIEW vw_account_pay_dim AS 
...
CREATE VIEW vw_account_pie_dim AS 
...
CREATE VIEW vw_party_account_rel AS 
SELECT dip_party_id,
       dip_account_id,
       record_effective_timestamp,
       record_expiry_timestamp,
...
CREATE VIEW vw_party_account_rel_type AS 
