...
impala-shell --quiet -i ird10139au.vsp.sas.com:25003  -d dev_raw --var="v1=${disk_threshold}" --var="v2=${mem_threshold}" --var="v3=${cpu_threshold}" --var="v4=${disk_exclude}" --var="v5=${mem_exclude}" --var="v6=${cpu_exclude}" -f "${sql_file}" -k --ssl --ca_cert=/sso/hadoop/cloudera-certs/CACerts/sas-hadoop-truststore.pem >$body
