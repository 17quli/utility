...
a.fcurResDeductionsPriorYear  AS fcurResDeductionsPriorYear,
a.fcurResDeductionsClaimed  AS fcurResDeductionsClaimed,
a.fcurResNetIncome AS fcurResNetIncome,
a.fcurResDeductionsForward AS fcurResDeductionsForward,
a.fcurRDICarryForwardCurrentYear  AS fcurRDICarryForwardCurrentYear,
a.fcurRDICarryForwardRemaining  AS fcurRDICarryForwardRemaining,
a.fcurPropertyProfitLoss  AS fcurPropertyProfitLoss,
