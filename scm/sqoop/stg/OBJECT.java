// ORM class for table 'OBJECT'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Thu May 07 20:27:44 GMT 2020
...
public class OBJECT extends SqoopRecord  implements DBWritable, Writable {
  ...
  public OBJECT with_PK_COLUMN_NAMES(String PK_COLUMN_NAMES) {
    this.PK_COLUMN_NAMES = PK_COLUMN_NAMES;
    return this;
  }
  ...
  public OBJECT with_NK_COLUMN_NAMES(String NK_COLUMN_NAMES) {
    this.NK_COLUMN_NAMES = NK_COLUMN_NAMES;
    return this;
  }
  private String EXCLUDED_COLUMNS;
  public String get_EXCLUDED_COLUMNS() {
    return EXCLUDED_COLUMNS;
  }
  public void set_EXCLUDED_COLUMNS(String EXCLUDED_COLUMNS) {
    this.EXCLUDED_COLUMNS = EXCLUDED_COLUMNS;
  }
  public OBJECT with_EXCLUDED_COLUMNS(String EXCLUDED_COLUMNS) {
    this.EXCLUDED_COLUMNS = EXCLUDED_COLUMNS;
    return this;
  }
  ...
  public String get_CUSTOM_SQL() {
    return CUSTOM_SQL;
  }
  public void set_CUSTOM_SQL(String CUSTOM_SQL) {
    this.CUSTOM_SQL = CUSTOM_SQL;
  }
  public OBJECT with_CUSTOM_SQL(String CUSTOM_SQL) {
    this.CUSTOM_SQL = CUSTOM_SQL;
    return this;
  }
  ...
  public OBJECT with_PARTITION_KEY(String PARTITION_KEY) {
    this.PARTITION_KEY = PARTITION_KEY;
    return this;
  }
  ...
  public OBJECT with_CREATED_ON(java.sql.Timestamp CREATED_ON) {
    this.CREATED_ON = CREATED_ON;
    return this;
  }
  ...
  public OBJECT with_UPDATED_BY(String UPDATED_BY) {
    this.UPDATED_BY = UPDATED_BY;
    return this;
  }
  ...
  public OBJECT with_UPDATED_ON(java.sql.Timestamp UPDATED_ON) {
    this.UPDATED_ON = UPDATED_ON;
    return this;
  }
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.EXCLUDED_COLUMNS = JdbcWritableBridge.readString(11, __dbResults);
    ...
    this.CUSTOM_SQL = JdbcWritableBridge.readString(15, __dbResults);
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    ...
    JdbcWritableBridge.writeString(EXCLUDED_COLUMNS, 11 + __off, 2005, __dbStmt);
    ...
    JdbcWritableBridge.writeString(CUSTOM_SQL, 15 + __off, 2005, __dbStmt);
...
this.readFields0(__dataIn);  }
  public void readFields0(DataInput __dataIn) throws IOException {
    ...
    this.EXCLUDED_COLUMNS = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
    ...
    this.CUSTOM_SQL = Text.readString(__dataIn);
    }
    if (__dataIn.readBoolean()) { 
  ...
  public void write(DataOutput __dataOut) throws IOException {
    ...
    if (null == this.EXCLUDED_COLUMNS) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, EXCLUDED_COLUMNS);
    }
    ...
    if (null == this.CUSTOM_SQL) { 
        ...
        __dataOut.writeBoolean(false);
    Text.writeString(__dataOut, CUSTOM_SQL);
    }
  ...
  private void __loadFromFields(List<String> fields) {
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.EXCLUDED_COLUMNS = null; } else {
      this.EXCLUDED_COLUMNS = __cur_str;
    }
    ...
    __cur_str = __it.next();
    if (__cur_str.equals("null")) { this.CUSTOM_SQL = null; } else {
      this.CUSTOM_SQL = __cur_str;
    }
