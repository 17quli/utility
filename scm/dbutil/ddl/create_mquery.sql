...
select user,queryid,from_utc_timestamp(starttime,'NZ') strt,from_utc_timestamp(endtime,'NZ') nd
,trunc(cast(memory_per_node_peak as double)/1024/1024/1024) node
,trunc(cast(memory_aggregate_peak as double)/1024/1024/1024) agg,substr(statement,1,80) stmt
from dev_raw.mquery 
where oom='true' and user<>'ird0qal'
;
